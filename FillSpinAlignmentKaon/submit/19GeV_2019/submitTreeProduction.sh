...
codePath=/star/u/gwilks3/Workspace/VectorMesonSpinAlignment/VecMesonSpinAlignment/FillSpinAlignmentKaon
...
outDir=${pid}${SM}_EtaMode${etamode}_20241016_cent2060_kaonspectra_TTrees_TPCOnly

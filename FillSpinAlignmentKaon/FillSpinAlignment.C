...
void FillSpinAlignment(const char* list = "../FileLists/19GeV_2019/Phi_ME_eta1p5_cent2060_TPCOnly_test.list", const char *jobId = "METEST", const Int_t energy = 4, const Int_t X_flag = 1, const Int_t mode = 0, const Int_t etamode = 0)
{

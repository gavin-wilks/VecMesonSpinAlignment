#ifndef StVecMesonEpdCorrection_h
#define StVecMesonEpdCorrection_h
...
class StVecMesonEpdCorrection : public TObject
{
  public:
    StVecMesonEpdCorrection(Int_t energy);
    virtual ~StVecMesonEpdCorrection();
  ...
  ClassDef(StVecMesonEpdCorrection,1)
};

...
ClassImp(StVecMesonEpdCorrection)

TString StVecMesonEpdCorrection::mVStr[4] = {"neg70","neg30","pos30","pos70"};
TString StVecMesonEpdCorrection::mOrder = "2nd";
//---------------------------------------------------------------------------------

StVecMesonEpdCorrection::StVecMesonEpdCorrection(Int_t energy)
{
  mEnergy = energy;
}
...
StVecMesonEpdCorrection::~StVecMesonEpdCorrection()
{
  /* */
}
...
void StVecMesonEpdCorrection::InitReCenterCorrection()
{
...
void StVecMesonEpdCorrection::InitShiftCorrection()
{
...
bool StVecMesonEpdCorrection::passTrackEtaEast(StPicoTrack *track) // neg
{
...
bool StVecMesonEpdCorrection::passTrackEtaWest(StPicoTrack *track) // pos 
{
  Float_t eta = track->pMom().PseudoRapidity();
...
bool StVecMesonEpdCorrection::passTrackFull(StPicoTrack *track) // Full Event Plane pt Cut
{
...
//---------------------------------------------------------------------------------
TVector2 StVecMesonEpdCorrection::calq2Vector(StPicoTrack *track)
{
...
Float_t StVecMesonEpdCorrection::getWeight(StPicoTrack *track)
{
  Float_t pt = track->pMom().Perp();
  Float_t w;
...
TVector2 StVecMesonEpdCorrection::getReCenterPar_East( Int_t Cent9, Int_t RunIndex, Int_t vz_sign)
{
...
TVector2 StVecMesonEpdCorrection::getReCenterPar_West(Int_t Cent9, Int_t RunIndex, Int_t vz_sign)
{
  Float_t mean_qx, mean_qy;
  TVector2 qVector(0.0,0.0);
...
TVector2 StVecMesonEpdCorrection::getReCenterPar_Full(Int_t Cent9, Int_t RunIndex, Int_t vz_sign)
{
  Float_t mean_qx, mean_qy;
  TVector2 qVector(0.0,0.0);
...
void StVecMesonEpdCorrection::addTrack_EastRaw(StPicoTrack *track, Int_t Cent9, Int_t RunIndex)
{
...
void StVecMesonEpdCorrection::addTrack_WestRaw(StPicoTrack *track, Int_t Cent9, Int_t RunIndex)
{
  Float_t w = getWeight(track);
...
void StVecMesonEpdCorrection::addTrack_FullRaw(StPicoTrack *track, Int_t Cent9, Int_t RunIndex)
{
  Float_t w = getWeight(track);
...
void StVecMesonEpdCorrection::addTrack_East(StPicoTrack *track, Int_t Cent9, Int_t RunIndex, Int_t i)
{
  Float_t w = getWeight(track);
...
void StVecMesonEpdCorrection::addTrack_West(StPicoTrack *track, Int_t Cent9, Int_t RunIndex, Int_t i)
{
  Float_t w = getWeight(track);
...
void StVecMesonEpdCorrection::addTrack_Full(StPicoTrack *track, Int_t Cent9, Int_t RunIndex, Int_t i)
{
  Float_t w = getWeight(track);
...
void StVecMesonEpdCorrection::addTrack_A(StPicoTrack *track, Int_t Cent9, Int_t RunIndex, Int_t i)
{
  Float_t w = getWeight(track);
...
void StVecMesonEpdCorrection::addTrack_B(StPicoTrack *track, Int_t Cent9, Int_t RunIndex, Int_t i)
{
  Float_t w = getWeight(track);
...
void StVecMesonEpdCorrection::Randomization()
{
  TRandom3 Ran;
...
void StVecMesonEpdCorrection::print(TVector2 vector)
{
...
void StVecMesonEpdCorrection::clear()
{
...
bool StVecMesonEpdCorrection::passTrackEtaNumRawCut()
{
...
bool StVecMesonEpdCorrection::passTrackFullNumRawCut()
{
...
bool StVecMesonEpdCorrection::passTrackEtaNumCut()
{
...
bool StVecMesonEpdCorrection::passTrackFullNumCut()
{
...
//---------------------------------------------------------------------------------
// 2nd
TVector2 StVecMesonEpdCorrection::calPsi2_East_EP(Int_t k) // k = ShiftOrder
{
...
TVector2 StVecMesonEpdCorrection::calPsi2_West_EP(Int_t k) // k = ShiftOrder
{
  TVector2 PsiVector(0.0,0.0); 
...
TVector2 StVecMesonEpdCorrection::calPsi2_Full_EP(Int_t k) // k = ShiftOrder
{
  TVector2 PsiVector(0.0,0.0); 
...
Float_t StVecMesonEpdCorrection::AngleShift(Float_t Psi_raw)
{
...
//---------------------------------------------------------------------------------
Float_t StVecMesonEpdCorrection::calShiftAngle2East_EP(Int_t runIndex, Int_t Cent9, Int_t vz_sign)
{
...
Float_t StVecMesonEpdCorrection::calShiftAngle2West_EP(Int_t runIndex, Int_t Cent9, Int_t vz_sign)
{
...
Float_t StVecMesonEpdCorrection::calShiftAngle2A_EP(Int_t runIndex, Int_t Cent9, Int_t vz_sign)
{
...
Float_t StVecMesonEpdCorrection::calShiftAngle2B_EP(Int_t runIndex, Int_t Cent9, Int_t vz_sign)
{
...
Float_t StVecMesonEpdCorrection::calShiftAngle2Full_EP(Int_t runIndex, Int_t Cent9, Int_t vz_sign)
{
...
Float_t StVecMesonEpdCorrection::calShiftAngle2Full_EP(Int_t runIndex, Int_t Cent9, Int_t vz_sign, StPicoTrack *track)
{
...
void StVecMesonEpdCorrection::InitResolutionCorr()
{
...
Float_t StVecMesonEpdCorrection::getResolution2_EP(Int_t Cent9)
{
...
Float_t StVecMesonEpdCorrection::getResolution2_Full_EP(Int_t Cent9)
{
...
//---------------------------------------------------------------------------------
TVector2 StVecMesonEpdCorrection::getQVector(Int_t l) // east/west
{
...
TVector2 StVecMesonEpdCorrection::getQVectorRaw(Int_t l) // east/west
{
  TVector2 QVector(-99.9,-99.9);
...
Int_t StVecMesonEpdCorrection::getNumTrack(Int_t l) // east/west
{

...
#outDir=Phi/Forest
mode=6
#outDir=Epd_Step${mode}_RetryAgain
##########Mode Selection##########
...
outDir=Phi/Forest/FirstOrderPhi${SM}
#outDir=Phi/D12
...
##########Test Production##########
star-submit-template -template ${codePath}/submit/7GeV_2021/testEpdProductionTemp.xml -entities mode=$mode,energy=$energy,flag_ME=$flag_ME,flag_PID=$flag_PID,SM=$SM,library=$library,codePath=$codePath,outPath=$outPath,listPath=$listPath,outDir=$outDir
##########Test Production##########

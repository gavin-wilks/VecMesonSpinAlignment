...
energy=3  # 19GeV
library=SL21c
listPath=/star/u/gwilks3/Workspace/VectorMesonSpinAlignment/PidFlow/FileList/14p6GeV_2019
...
outDir=Phi/Forest/D12
#outDir=Phi/EpdStep${mode}
#outDir=Phi/D12
...
##########Test Production##########
star-submit-template -template ${codePath}/submit/14GeV_2019/testEpdProductionTemp.xml -entities mode=$mode,energy=$energy,flag_ME=$flag_ME,flag_PID=$flag_PID,SM=$SM,library=$library,codePath=$codePath,outPath=$outPath,listPath=$listPath,outDir=$outDir
##########Test Production##########
...
##########Re-Submit##########
#star-submit-template -template resubmitEpdProductionTemp.xml -entities mode=$mode,energy=$energy,flag_ME=$flag_ME,flag_PID=$flag_PID,SM=$SM,library=$library,codePath=$codePath,outPath=$outPath,listPath=$listPath,outDir=$outDir

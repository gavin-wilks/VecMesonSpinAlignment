...
if (  "$SLURM_JOB_PARTITION" =~ *"chos"  ) then  
    ...
    echo `pwd`
    /usr/bin/time -v  $EXEC_NAME -b -q ZdcSmdTree.C\(\"$daqN\",${SLURM_ARRAY_TASK_ID},$mode,$energy,$flag_ME\) >& $LOG_PATH/phi${SM}${Energy}_${SLURM_ARRAY_JOB_ID}_${SLURM_ARRAY_TASK_ID}.log

...
for((j=0; j<${numjobs}; j++ ))
do
if [ "`ls -d -1 /gpfs01/star/${where}/gwilks3/VectorMesonSpinAlignment/AuAu19GeV_2019/OutPut/SpinAlignment/${part}/Forest/${part}${SM}/file_19GeV_${part}_${SM}_${jobid}_${j}.root`" !=  "/gpfs01/star/${where}/gwilks3/VectorMesonSpinAlignment/AuAu19GeV_2019/OutPut/SpinAlignment/${part}/Forest/${part}${SM}/file_19GeV_${part}_${SM}_${jobid}_${j}.root" ]

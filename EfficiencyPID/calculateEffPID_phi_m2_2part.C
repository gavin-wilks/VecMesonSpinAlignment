...
void calculateEffPID_phi_m2_2part(const int energy = 4, const string date = "20240703")
{
  double kaonlimitlow = 0.1;
  double kaonlimitup = 0.125;
  ...
  TH2D *h_mPID[2][20][10][12]; // x axis is nsigma_kaon, y axis is m^2
  //TH1D *h_mPID_nsig[2][20][10][12];
  TH1D *h_mPID_m2[2][20][10][12]; 
  TF2 *f_mPID[2][20][10][12];
  //TF1 *f_mPID_nsig[2][20][10][12];
  TF1 *f_mPID_m2[2][20][10][12];
  TFitResultPtr fitResult_mPID_m2[2][20][10][12];
  TF1 *f_1D_mPID[3][2][20][10][12]; // first array runs over particle type: pion, kaon, proton
  //TF1 *f_1D_mPID_nsig[3][2][20][10][12];
  TF1 *f_1D_mPID_m2[3][2][20][10][12];
  TGraphAsymmErrors *g_mPID_m2_pt_norm[3][2][10][12];
  TGraphAsymmErrors *g_mPID_m2_pt_mean[3][2][10][12];
  TGraphAsymmErrors *g_mPID_m2_pt_sigma[3][2][10][12];
  TGraphAsymmErrors *g_mPID_m2_pt_ratio[2][10][12];
  TGraphAsymmErrors *g_mPID_m2_eta_ratio[2][20][12];
  TGraphAsymmErrors *g_mPID_m2_phi_ratio[2][20][10];
        ...
        for(int ieta = 0; ieta < 10; ieta++)
        {
          for(int iphi = 0; iphi < 12; iphi++)
          {
            ...
            {            
              ...
              for(int ipt2 = 14; ipt2 < pt_max_up; ipt2++)
              {
            ...
            f_mPID_m2[ic][ipt][ieta][iphi] = new TF1(FuncName.c_str(),TwoParticleGaussian,-0.5,0.425,6);
            f_mPID_m2[ic][ipt][ieta][iphi]->SetParameter(0,h_mPID_m2[ic][ipt][ieta][iphi]->GetMaximum());
            f_mPID_m2[ic][ipt][ieta][iphi]->SetParLimits(0,0.0,1000000000);
            f_mPID_m2[ic][ipt][ieta][iphi]->SetParameter(1,0.01822044);
            f_mPID_m2[ic][ipt][ieta][iphi]->SetParLimits(1,0.01822044-0.1,0.01822044+0.06);
            f_mPID_m2[ic][ipt][ieta][iphi]->SetParameter(2,0.002+0.006*ipt);
            f_mPID_m2[ic][ipt][ieta][iphi]->SetParLimits(2,0.0,0.2);
            f_mPID_m2[ic][ipt][ieta][iphi]->SetParameter(3,h_mPID_m2[ic][ipt][ieta][iphi]->GetMaximum()/3.0);
            f_mPID_m2[ic][ipt][ieta][iphi]->SetParLimits(3,0.0,1000000000);
            ...
            f_mPID_m2[ic][ipt][ieta][iphi]->SetParLimits(5,0.0,0.25);

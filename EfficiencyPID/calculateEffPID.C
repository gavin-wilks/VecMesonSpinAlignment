...
void calculateEffPID(const int energy = 4, const string date = "20240702")
{
    ...
    for(int ic = 1; ic < 2; ic++)
    {
      ...
      for(int ipt = 0; ipt < 20; ipt++)
      {
        for(int ieta = 10; ieta < 11; ieta++)
        {
          ...
          f_mPID_m2[icent][ic][ipt][ieta] = new TF1(FuncName.c_str(),ThreeParticleGaussian,-0.5,1.5,9);
          f_mPID_m2[icent][ic][ipt][ieta]->SetParameter(0,h_mPID_m2[icent][ic][ipt][ieta]->GetMaximum());
          f_mPID_m2[icent][ic][ipt][ieta]->SetParameter(1,0.01822044);
          f_mPID_m2[icent][ic][ipt][ieta]->SetParLimits(1,0.01822044-0.1,0.01822044+0.1);
          f_mPID_m2[icent][ic][ipt][ieta]->SetParameter(2,0.002+0.006*ipt);
          f_mPID_m2[icent][ic][ipt][ieta]->SetParameter(3,h_mPID_m2[icent][ic][ipt][ieta]->GetMaximum()/3.0);
          f_mPID_m2[icent][ic][ipt][ieta]->SetParameter(4,0.247618);
          f_mPID_m2[icent][ic][ipt][ieta]->SetParLimits(4,0.247618-0.1,0.247618+0.1);
          f_mPID_m2[icent][ic][ipt][ieta]->SetParameter(5,0.008+0.012*ipt);
          f_mPID_m2[icent][ic][ipt][ieta]->SetParameter(6,h_mPID_m2[icent][ic][ipt][ieta]->GetMaximum()/2.0);
          f_mPID_m2[icent][ic][ipt][ieta]->SetParameter(7,0.880354);
          f_mPID_m2[icent][ic][ipt][ieta]->SetParLimits(7,0.880354-0.2,0.880354+0.2);
          f_mPID_m2[icent][ic][ipt][ieta]->SetParameter(8,0.044+0.012*ipt);

          h_mPID_m2[icent][ic][ipt][ieta]->Fit(f_mPID_m2[icent][ic][ipt][ieta],"NMRI");


          for(int ip = 0; ip < 3; ip++)
          {
            g_mPID_m2_pt_norm[ip][icent][ic][ieta]->SetPoint(ipt,0.1+ipt*0.2,f_mPID_m2[icent][ic][ipt][ieta]->GetParameter(3*ip));
            g_mPID_m2_pt_norm[ip][icent][ic][ieta]->SetPointError(ipt,0.0,0.0,f_mPID_m2[icent][ic][ipt][ieta]->GetParError(3*ip),f_mPID_m2[icent][ic][ipt][ieta]->GetParError(3*ip));
            g_mPID_m2_pt_mean[ip][icent][ic][ieta]->SetPoint(ipt,0.1+ipt*0.2,f_mPID_m2[icent][ic][ipt][ieta]->GetParameter(1+3*ip));
            g_mPID_m2_pt_mean[ip][icent][ic][ieta]->SetPointError(ipt,0.0,0.0,f_mPID_m2[icent][ic][ipt][ieta]->GetParError(1+3*ip),f_mPID_m2[icent][ic][ipt][ieta]->GetParError(1+3*ip));
            g_mPID_m2_pt_sigma[ip][icent][ic][ieta]->SetPoint(ipt,0.1+ipt*0.2,f_mPID_m2[icent][ic][ipt][ieta]->GetParameter(2+3*ip));
            g_mPID_m2_pt_sigma[ip][icent][ic][ieta]->SetPointError(ipt,0.0,0.0,f_mPID_m2[icent][ic][ipt][ieta]->GetParError(2+3*ip),f_mPID_m2[icent][ic][ipt][ieta]->GetParError(2+3*ip));
          }
  ...
  double N_kaon_total[10][2][20][20];
  double N_kaon_selected[10][2][20][20];
    ...
    for(int ic = 1; ic < 2; ic++)
    {
      for(int ipt = 0; ipt < 20; ipt++)
      {
	    ...
	    f_1D_mPID_m2[ipart][icent][ic][ipt][ieta]->SetLineStyle(1);
            ...
            if(ipart == 1)
            {          
              double kaons_selected  = f_1D_mPID_m2[ipart][icent][ic][ipt][ieta]->Integral(0.16,0.36);   
              double dkaons_selected = f_1D_mPID_m2[ipart][icent][ic][ipt][ieta]->IntegralError(0.16,0.36);   
              double kaons_total     = f_1D_mPID_m2[ipart][icent][ic][ipt][ieta]->Integral(-0.5,1.5);   
              double dkaons_total    = f_1D_mPID_m2[ipart][icent][ic][ipt][ieta]->IntegralError(0.,0.36);   
            }
          }

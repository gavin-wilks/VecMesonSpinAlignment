...
ClassImp(StVecMesonEpdCut)

StRefMultCorr* StVecMesonEpdCut::mRefMultCorr = NULL;
//---------------------------------------------------------------------------------

StVecMesonEpdCut::StVecMesonEpdCut(const int energy)
{
  mEnergy = energy;
  if(!mRefMultCorr)
  {
...
StVecMesonEpdCut::~StVecMesonEpdCut()
{
  /* */
}
...
bool StVecMesonEpdCut::isMinBias(StPicoEvent *picoEvent)
{
...
bool StVecMesonEpdCut::isPileUpEvent(int refMult, int numOfBTofMatch, double vz)
{
...
double StVecMesonEpdCut::getRefMultReweight(double vz, int refMult)
{
  if(mEnergy == 4)
  { 
...
int StVecMesonEpdCut::getCentrality(double refMultCorr) // 9 Centrality bins 
{
  if(mEnergy == 4)
  {
...
double StVecMesonEpdCut::getEventWeight(int cent9, double refMult)
{
  if(mEnergy == 4)
  {
...
bool StVecMesonEpdCut::passEventCut(StPicoDst *pico)
{
...
Int_t StVecMesonEpdCut::getMatchedToF()
{
  return mMatchedToF;
}

Int_t StVecMesonEpdCut::getNpirm()
{
  return mN_prim;
}

Int_t StVecMesonEpdCut::getNnonprim()
{
  return mN_non_prim;
}
//---------------------------------------------------------------------------------

Float_t StVecMesonEpdCut::getBeta(StPicoTrack *picoTrack, StPicoDst *picoDst)
{
  double beta = -999.9;
...
Float_t StVecMesonEpdCut::getPrimaryMass2(StPicoTrack *picoTrack, StPicoDst *picoDst)
{
  double mass2 = -999.9;
  // StPicoTrack *picoTrack = (StPicoTrack*)picoDst->track(i_track); // return ith track
  int tofIndex = picoTrack->bTofPidTraitsIndex(); // return ToF PID traits
...
Float_t StVecMesonEpdCut::getV0Mass2(StPicoTrack *picoTrack, StPicoDst *picoDst)
{
  double mass2 = -999.9;
  // StPicoTrack *picoTrack = (StPicoTrack*)picoDst->track(i_track); // return ith track
  int tofIndex = picoTrack->bTofPidTraitsIndex(); // return ToF PID traits
...
bool StVecMesonEpdCut::passSigPionCut(StPicoTrack* track, Int_t pid)
{
...
bool StVecMesonEpdCut::passSigKaonCut(StPicoTrack* track, Int_t pid)
{
...
bool StVecMesonEpdCut::passTrackBasic(StPicoTrack *track)
{
  // nHitsFit cut
...
bool StVecMesonEpdCut::passTrackEP(StPicoTrack *track, StPicoEvent *picoEvent)
{
...
//---------------------------------------------------------------------------------
bool StVecMesonEpdCut::passTrackMeson(StPicoTrack *track, StPicoEvent *picoEvent, Int_t pid)
{
  if(!track) return kFALSE;

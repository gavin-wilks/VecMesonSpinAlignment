...
class StMesonTrack : public TObject
{
  ...
  public:
    StMesonTrack() :
      mMass2A(-999.9),mMass2B(-999.9),mNSigA(-999.9),mNSigB(-999.9),mDcaA(-999.9),mDcaB(-999.9),mNHitsFitA(-999.9),mNHitsFitB(-999.9),mNHitsMaxA(-999.9),mNHitsMaxB(-999.9),mDEdxA(-999.9),mDEdxB(-999.9),mTrackA(0,0,0,0),mTrackB(0,0,0,0),mFlagA(-1),mFlagB(-1),mWeightA(-999.9),mWeightB(-999.9)
  {
  }
    ~StMesonTrack() {}
    ...
    void setWeightA(Float_t f)                   { mWeightA = f;        }
    void setWeightB(Float_t f)                   { mWeightB = f;        }
    ...
    Float_t getWeightA() const                 { return mWeightA;     }
    Float_t getWeightB() const                 { return mWeightB;     }

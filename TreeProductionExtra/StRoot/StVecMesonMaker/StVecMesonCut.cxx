...
bool StVecMesonCut::isMinBias(StPicoEvent *picoEvent)
{
  ...
  if(mEnergy == 1 && vmsa::mBeamYear[mEnergy] == picoEvent->year() && !( picoEvent->isTrigger(780010) || picoEvent->isTrigger(780020) )) return false; // 9.2GeV_2020
  if(mEnergy == 2 && vmsa::mBeamYear[mEnergy] == picoEvent->year() && !( picoEvent->isTrigger(710000) || picoEvent->isTrigger(710010) || picoEvent->isTrigger(710020) )) return false; // 11.5GeV_2020
  ...
  if(mEnergy == 5 && vmsa::mBeamYear[mEnergy] == picoEvent->year() && !(  picoEvent->isTrigger(870010) )) return false; // 17.3GeV_2021
  return true;
}

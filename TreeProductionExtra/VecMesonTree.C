...
void VecMesonTree(const Char_t *inputFile="../FileListGenerators/19GeV_2019/pico_prod_test.list", const Char_t *jobId = "PIDTEST", const Int_t Mode = 3, const Int_t energy = 4, const Int_t flag_ME = 1, const Int_t flag_PID = 0)
{

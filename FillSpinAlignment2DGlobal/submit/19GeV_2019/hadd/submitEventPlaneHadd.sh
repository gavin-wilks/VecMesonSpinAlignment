...
#energy=1  # 19p6GeV
#library=SL21c
listPath=/star/u/gwilks3/Workspace/VectorMesonSpinAlignment/VecMesonSpinAlignment/FillSpinAlignment2DGlobal/submit/19GeV_2019/hadd
...
outDir=${part}${SM}_etamode${etamode}_20241017_Helicity_2D_Study${study}
...
##########Full Production##########
star-submit-template -template myhadd.xml -entities study=$study,etamode=${etamode},SM=$SM,outFile=$outFile,outPath=$outPath,outDir=$outDir,listPath=$listPath
##########Full Production##########

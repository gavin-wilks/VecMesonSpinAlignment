...
void FillSpinAlignment(const char* list = "../FileLists/19GeV_2019/Phi_SE_eta1_allcent.list", const char *jobId = "AllCent_TPCTOF_NoSys", const Int_t energy = 4, const Int_t X_flag = 0, const Int_t mode = 0, const Int_t etamode = 0, Int_t study = 3)
{

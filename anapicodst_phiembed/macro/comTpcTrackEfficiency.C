...
void comTpcTrackEfficiency(int energy = 0, int mpid = 0, int pid = 0, int year = 0, int EP = 0)
{
  gStyle->SetOptDate(0);
  gRandom->SetSeed();
  ...
  string innput_0080 = Form("/gpfs01/star/pwg/gwilks3/VectorMesonSpinAlignment/Data/%s/Efficiency/TPC/Eff_%s_%s%s.root",vmsa::mPID[mpid].c_str(),vmsa::mParType[pid].c_str(),vmsa::mBeamEnergy[energy].c_str(),eventplane.c_str());

...
void makePicoDstQA_Phi(TString InputFileList, Int_t nEvents = 0, TString OutputFile = "test.histo", TString jobId = "1", Int_t mEnergy = 4, Int_t mGid = 11, Int_t mPid = 0, bool phiswitch = 1, Float_t rho00 = 1./3., Float_t real = 0.0, Float_t imag = 0.0, Float_t rerho1n1 = 0.0, Float_t imrho1n1 = 0.0, Float_t hrho00 = 1./3., Float_t hreal = 0.0, Float_t himag = 0.0, Float_t hrerho1n1 = 0.0, Float_t himrho1n1 = 0.0);

void makePicoDstQA_Phi(TString InputFileList, Int_t nEvents, TString OutputFile, TString jobId, Int_t mEnergy, Int_t mGid, Int_t mPid, bool phiswitch, Float_t rho00, Float_t real, Float_t imag, Float_t rerho1n1, Float_t imrho1n1, Float_t hrho00, Float_t hreal, Float_t himag, Float_t hrerho1n1, Float_t himrho1n1) 
{
  int mQAHist = 0;
  int mCorrection = 0;
  int mEP = 0;
  ...
  if(mEP) mUtility->initEventPlane(); // initialize std::map for event planes 
  ...
  if(mQAHist == 1) mEffHistManger->InitHistQA();
  ...
  // ---------------- modify here according to your QA purpose --------------------------
     ...
     float ep_full = 0.0;//mUtility->findEPfull(eventId);
     if(mEP) ep_full = mUtility->findEPfull(eventId);
     if( ep_west < -900.0 || ep_east < -900.0 || ep_full < -900.0 )
     {
       LOG_ERROR << "Could not find this event plane from StUtility! Skip!" << endm; continue;
     }

     if(mQAHist == 1) mEffHistManger->FillEventHistQA(reweight, cent9, vx, vy, vz, nBTofMatched, refMult);
     ...
     for(std::map< int, std::pair<StPicoMcTrack*,StPicoMcTrack*> >::iterator phi = phiMesonMcDaughters.begin(); phi != phiMesonMcDaughters.end(); phi++) 
     {
       ...
       if(!mCorrection) mEffHistManger->FillHistRc(reweight,cent9,rlphi.Pt(),rlphi.Eta(),rlphi.Rapidity(),rlphi.Phi(),ep_full,rKP_Pt,rKP_Eta,rKP_Y,rKP_Phi,rKM_Pt,rKM_Eta,rKM_Y,rKM_Phi,l_meson.Pt(),l_meson.Phi(),l_meson.Rapidity(),phistarRc,RcCosThetaStar,phiprimeRc,costhetaRc,helicityangleRc,KP_M2,KM_M2,rkp_ns,rkm_ns,3);
       if(mQAHist == 1) mEffHistManger->FillTrackHistQA(reweight, cent9, 0, rKP_dca, rKP_nhits, rKP_nhitsratio, rKP_P, rKP_dedx, 3);
       if(mQAHist == 1) mEffHistManger->FillTrackHistQA(reweight, cent9, 1, rKM_dca, rKM_nhits, rKM_nhitsratio, rKM_P, rKM_dedx, 3);
       if(mCorrection) mEffHistManger->FillHistRc(reweight,cent9,lphi.Pt(),lphi.Eta(),lphi.Rapidity(),lphi.Phi(),ep_full,KP_Pt,KP_Eta,KP_Y,KP_Phi,KM_Pt,KM_Eta,KM_Y,KM_Phi,l_meson.Pt(),l_meson.Phi(),l_meson.Rapidity(),phistar,McCosThetaStar,mcphiprime,costheta,helicityangle,KP_M2,KM_M2,0.0,0.0,3);
       ...
       if(!mCorrection)  mEffHistManger->FillHistRc(reweight,cent9,rlphi.Pt(),rlphi.Eta(),rlphi.Rapidity(),rlphi.Phi(),ep_full,rKP_Pt,rKP_Eta,rKP_Y,rKP_Phi,rKM_Pt,rKM_Eta,rKM_Y,rKM_Phi,l_meson.Pt(),l_meson.Phi(),l_meson.Rapidity(),phistarRc,RcCosThetaStar,phiprimeRc,costhetaRc,helicityangleRc,KP_M2,KM_M2,rkp_ns,rkm_ns,4);
       if(mQAHist == 1) mEffHistManger->FillTrackHistQA(reweight, cent9, 0, rKP_dca, rKP_nhits, rKP_nhitsratio, rKP_P, rKP_dedx, 4);
       if(mQAHist == 1) mEffHistManger->FillTrackHistQA(reweight, cent9, 1, rKM_dca, rKM_nhits, rKM_nhitsratio, rKM_P, rKM_dedx, 4);
       if(mCorrection) mEffHistManger->FillHistRc(reweight,cent9,lphi.Pt(),lphi.Eta(),lphi.Rapidity(),lphi.Phi(),ep_full,KP_Pt,KP_Eta,KP_Y,KP_Phi,KM_Pt,KM_Eta,KM_Y,KM_Phi,l_meson.Pt(),l_meson.Phi(),l_meson.Rapidity(),phistar,McCosThetaStar,mcphiprime,costheta,helicityangle,KP_M2,KM_M2,0.0,0.0,4);
       ...
       if(!mCorrection) mEffHistManger->FillHistRc(reweight,cent9,rlphi.Pt(),rlphi.Eta(),rlphi.Rapidity(),rlphi.Phi(),ep_full,rKP_Pt,rKP_Eta,rKP_Y,rKP_Phi,rKM_Pt,rKM_Eta,rKM_Y,rKM_Phi,l_meson.Pt(),l_meson.Phi(),l_meson.Rapidity(),phistarRc,RcCosThetaStar,phiprimeRc,costhetaRc,helicityangleRc,KP_M2,KM_M2,rkp_ns,rkm_ns,5);
       if(mQAHist == 1) mEffHistManger->FillTrackHistQA(reweight, cent9, 0, rKP_dca, rKP_nhits, rKP_nhitsratio, rKP_P, rKP_dedx, 5);
       if(mQAHist == 1) mEffHistManger->FillTrackHistQA(reweight, cent9, 1, rKM_dca, rKM_nhits, rKM_nhitsratio, rKM_P, rKM_dedx, 5);
       if(mCorrection) mEffHistManger->FillHistRc(reweight,cent9,lphi.Pt(),lphi.Eta(),lphi.Rapidity(),lphi.Phi(),ep_full,KP_Pt,KP_Eta,KP_Y,KP_Phi,KM_Pt,KM_Eta,KM_Y,KM_Phi,l_meson.Pt(),l_meson.Phi(),l_meson.Rapidity(),phistar,McCosThetaStar,mcphiprime,costheta,helicityangle,KP_M2,KM_M2,0.0,0.0,5);
...
//       mEffHistManger->FillHistRc(reweight,cent9,rlphi.Pt(),rlphi.Eta(),rlphi.Rapidity(),rlphi.Phi(),ep_full,rKP_Pt,rKP_Eta,rKP_Y,rKP_Phi,rKM_Pt,rKM_Eta,rKM_Y,rKM_Phi,l_meson.Pt(),l_meson.Phi(),l_meson.Rapidity(),phistarRc,RcCosThetaStar,phiprimeRc,costhetaRc,helicityangleRc,KP_M2,KM_M2,rkp_ns,rkm_ns,6);
       if(mQAHist == 1) mEffHistManger->FillTrackHistQA(reweight, cent9, 0, rKP_dca, rKP_nhits, rKP_nhitsratio, rKP_P, rKP_dedx, 6);
       if(mQAHist == 1) mEffHistManger->FillTrackHistQA(reweight, cent9, 1, rKM_dca, rKM_nhits, rKM_nhitsratio, rKM_P, rKM_dedx, 6);
       ...
       if(!mCorrection) mEffHistManger->FillHistRc(reweight,cent9,rlphi.Pt(),rlphi.Eta(),rlphi.Rapidity(),rlphi.Phi(),ep_full,rKP_Pt,rKP_Eta,rKP_Y,rKP_Phi,rKM_Pt,rKM_Eta,rKM_Y,rKM_Phi,l_meson.Pt(),l_meson.Phi(),l_meson.Rapidity(),phistarRc,RcCosThetaStar,phiprimeRc,costhetaRc,helicityangleRc,KP_M2,KM_M2,rkp_ns,rkm_ns,7);
       if(mQAHist == 1) mEffHistManger->FillTrackHistQA(reweight, cent9, 0, rKP_dca, rKP_nhits, rKP_nhitsratio, rKP_P, rKP_dedx, 7);
       if(mQAHist == 1) mEffHistManger->FillTrackHistQA(reweight, cent9, 1, rKM_dca, rKM_nhits, rKM_nhitsratio, rKM_P, rKM_dedx, 7);
       if(mCorrection) mEffHistManger->FillHistRc(reweight,cent9,lphi.Pt(),lphi.Eta(),lphi.Rapidity(),lphi.Phi(),ep_full,KP_Pt,KP_Eta,KP_Y,KP_Phi,KM_Pt,KM_Eta,KM_Y,KM_Phi,l_meson.Pt(),l_meson.Phi(),l_meson.Rapidity(),phistar,McCosThetaStar,mcphiprime,costheta,helicityangle,KP_M2,KM_M2,0.0,0.0,7);
       ...
       if(!mCorrection) mEffHistManger->FillHistRc(reweight,cent9,rlphi.Pt(),rlphi.Eta(),rlphi.Rapidity(),rlphi.Phi(),ep_full,rKP_Pt,rKP_Eta,rKP_Y,rKP_Phi,rKM_Pt,rKM_Eta,rKM_Y,rKM_Phi,l_meson.Pt(),l_meson.Phi(),l_meson.Rapidity(),phistarRc,RcCosThetaStar,phiprimeRc,costhetaRc,helicityangleRc,KP_M2,KM_M2,rkp_ns,rkm_ns,8);
       if(mQAHist == 1) mEffHistManger->FillTrackHistQA(reweight, cent9, 0, rKP_dca, rKP_nhits, rKP_nhitsratio, rKP_P, rKP_dedx, 8);
       if(mQAHist == 1) mEffHistManger->FillTrackHistQA(reweight, cent9, 1, rKM_dca, rKM_nhits, rKM_nhitsratio, rKM_P, rKM_dedx, 8);
       if(mCorrection) mEffHistManger->FillHistRc(reweight,cent9,lphi.Pt(),lphi.Eta(),lphi.Rapidity(),lphi.Phi(),ep_full,KP_Pt,KP_Eta,KP_Y,KP_Phi,KM_Pt,KM_Eta,KM_Y,KM_Phi,l_meson.Pt(),l_meson.Phi(),l_meson.Rapidity(),phistar,McCosThetaStar,mcphiprime,costheta,helicityangle,KP_M2,KM_M2,0.0,0.0,8);
       ...
       if(!mCorrection) mEffHistManger->FillHistRc(reweight,cent9,rlphi.Pt(),rlphi.Eta(),rlphi.Rapidity(),rlphi.Phi(),ep_full,rKP_Pt,rKP_Eta,rKP_Y,rKP_Phi,rKM_Pt,rKM_Eta,rKM_Y,rKM_Phi,l_meson.Pt(),l_meson.Phi(),l_meson.Rapidity(),phistarRc,RcCosThetaStar,phiprimeRc,costhetaRc,helicityangleRc,KP_M2,KM_M2,rkp_ns,rkm_ns,9);
       if(mQAHist == 1) mEffHistManger->FillTrackHistQA(reweight, cent9, 0, rKP_dca, rKP_nhits, rKP_nhitsratio, rKP_P, rKP_dedx, 9);
       if(mQAHist == 1) mEffHistManger->FillTrackHistQA(reweight, cent9, 1, rKM_dca, rKM_nhits, rKM_nhitsratio, rKM_P, rKM_dedx, 9);
       if(mCorrection) mEffHistManger->FillHistRc(reweight,cent9,lphi.Pt(),lphi.Eta(),lphi.Rapidity(),lphi.Phi(),ep_full,KP_Pt,KP_Eta,KP_Y,KP_Phi,KM_Pt,KM_Eta,KM_Y,KM_Phi,l_meson.Pt(),l_meson.Phi(),l_meson.Rapidity(),phistar,McCosThetaStar,mcphiprime,costheta,helicityangle,KP_M2,KM_M2,0.0,0.0,9);
  ...
  if(mQAHist == 1) mEffHistManger->WriteHistQA();

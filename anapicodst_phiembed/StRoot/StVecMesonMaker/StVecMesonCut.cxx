...
bool StVecMesonCut::isMinBias(StPicoEvent *picoEvent)
{
  ...
  //if(mEnergy == 4 && vmsa::mBeamYear[mEnergy] == picoEvent->year() && !( picoEvent->isTrigger(640001) || picoEvent->isTrigger(640011) || picoEvent->isTrigger(640021) || picoEvent->isTrigger(640031) || picoEvent->isTrigger(640041) || picoEvent->isTrigger(640051) || picoEvent->isTrigger(640002) || picoEvent->isTrigger(640012) || picoEvent->isTrigger(640022) || picoEvent->isTrigger(640032) )) return false; // 19.6GeV_2019
  return true;
}
...
// START OF GAVIN COMMENT OUT 07/24/2024 
...
Float_t StVecMesonCut::getPrimaryMass2(StPicoTrack *picoTrack, StPicoDst *picoDst)
{
  ...
  if(tofIndex >= 0)
  {
    ...
    if(tofTrack->btofMatchFlag() > 0 && tofTrack->btof() != 0)
    {
      cout << "We have TOF information" << endl;

...
codePath=/star/u/gwilks3/Workspace/VectorMesonSpinAlignment/VecMesonSpinAlignment/TreeProductionToFMatching
...
outDir=Phi/Forest/Phi${SM}_eta1_20240925_TPCTOF_Tagged_NOTcent2060_extrainfo

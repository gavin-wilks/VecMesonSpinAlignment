...
outPath=/gpfs01/star/scratch/gwilks3/VectorMesonSpinAlignment/AuAu7GeV_2021
##########Energy Selection##########
...
outDir=${pid}${SM}_FirstOrder_EtaMode${etamode}_20240511
...
##########Test Production##########
star-submit-template -template testEpdProductionTemp.xml -entities etamode=$etamode,pid=$pid,mode=$mode,energy=$energy,flag_ME=$flag_ME,SM=$SM,library=$library,codePath=$codePath,outPath=$outPath,listPath=$listPath,outDir=$outDir
##########Test Production##########

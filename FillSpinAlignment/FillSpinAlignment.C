...
void FillSpinAlignment(const char* list = "../FileLists/19GeV_2019/Phi_ME_Forest.list", const char *jobId = "test", const Int_t energy = 4, const Int_t X_flag = 1, const Int_t mode = 0)
{

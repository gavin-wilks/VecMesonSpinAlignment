...
void FillSpinAlignment(const char* list = "testing.list", const char *jobId = "TESTING", const Int_t energy = 4, const Int_t X_flag = 0, const Int_t mode = 0, const Int_t etamode = 0)
{

...
codePath=/star/u/gwilks3/Workspace/VectorMesonSpinAlignment/VecMesonSpinAlignment/FillSpinAlignment2DToFMatching
...
outDir=${pid}${SM}_EtaMode${etamode}_20241218_ToFTagging_dipanglefixed

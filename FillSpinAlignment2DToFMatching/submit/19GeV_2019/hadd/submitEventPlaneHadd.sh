...
#energy=1  # 19p6GeV
#library=SL21c
listPath=/star/u/gwilks3/Workspace/VectorMesonSpinAlignment/VecMesonSpinAlignment/FillSpinAlignment2DToFMatching/submit/19GeV_2019/hadd
...
outDir=${part}${SM}_etamode${etamode}_20240926_ToFTagging

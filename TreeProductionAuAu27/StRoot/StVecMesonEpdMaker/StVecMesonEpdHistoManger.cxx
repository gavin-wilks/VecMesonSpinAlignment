...
ClassImp(StVecMesonEpdHistoManger)

//-------------------------------------------------------------------------------------------

StVecMesonEpdHistoManger::StVecMesonEpdHistoManger()
{
}
...
//-------------------------------------------------------------------------------------------
void StVecMesonEpdHistoManger::InitQA()
{
...
void StVecMesonEpdHistoManger::FillQA_Detector(Float_t dEdx, Float_t Mass2, Float_t p)
{
  h_mDEdx->Fill(p,dEdx);
  h_mMass2->Fill(p,Mass2);
}

void StVecMesonEpdHistoManger::FillQA_Event(Float_t vz, Float_t refMult)
{
  h_mVz->Fill(vz);
  h_mRefMult->Fill(refMult);
}

void StVecMesonEpdHistoManger::FillEP_Eta(Float_t Psi2_East, Float_t Psi2_West)
{
  h_mEastRaw->Fill(Psi2_East);
  h_mWestRaw->Fill(Psi2_West);
}

void StVecMesonEpdHistoManger::FillEP_Full(Float_t Psi2_Full)
{
  h_mFullRaw->Fill(Psi2_Full);
}

void StVecMesonEpdHistoManger::WriteQA()
{
  h_mDEdx->Write();
  h_mMass2->Write();
  h_mVz->Write();
...
//-------------------------------------------------------------------------------------------
void StVecMesonEpdHistoManger::InitEP()
{
...
void StVecMesonEpdHistoManger::FillEP_Sub(Float_t Psi2East_ReCenter, Float_t Psi2East_Shift, Float_t Psi2West_ReCenter, Float_t Psi2West_Shift)
{
...
void StVecMesonEpdHistoManger::FillEP_Ran(Float_t Psi2RanA_ReCenter, Float_t Psi2RanA_Shift, Float_t Psi2RanB_ReCenter, Float_t Psi2RanB_Shift, Float_t Psi2Full_ReCenter, Float_t Psi2Full_Shift)
{
...
void StVecMesonEpdHistoManger::WriteEP()
{

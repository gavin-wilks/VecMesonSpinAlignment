#ifndef StVecMesonEpdHistoManger_h
#define StVecMesonEpdHistoManger_h
...
{
  public:
    StVecMesonEpdHistoManger();
    virtual ~StVecMesonEpdHistoManger();
  ...
  ClassDef(StVecMesonEpdHistoManger,1)
};
#endif

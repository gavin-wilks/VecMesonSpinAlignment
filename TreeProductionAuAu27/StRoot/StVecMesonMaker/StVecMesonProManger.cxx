...
TString StVecMesonProManger::mVStr[2] = {"neg","pos"};
...
void StVecMesonProManger::InitReCenter()
{
  for(Int_t i = 0; i < 2; i++) // vertex pos/neg
  {
    ...
    p_mq2x_East_EP[i] = new TProfile2D(ProName.Data(),ProName.Data(),3000,-0.5,2999.5,9,-0.5,8.5);// neg eta || x axis is RunIndex, y axis is Centrality
    ProName = Form("qy_2nd_Vertex_%s_East",mVStr[i].Data());
    p_mq2y_East_EP[i] = new TProfile2D(ProName.Data(),ProName.Data(),3000,-0.5,2999.5,9,-0.5,8.5);// neg eta || x axis is RunIndex, y axis is Centrality
    ProName = Form("qx_2nd_Vertex_%s_West",mVStr[i].Data());
    p_mq2x_West_EP[i] = new TProfile2D(ProName.Data(),ProName.Data(),3000,-0.5,2999.5,9,-0.5,8.5);// pos eta || x axis is RunIndex, y axis is Centrality
    ProName = Form("qy_2nd_Vertex_%s_West",mVStr[i].Data());
    p_mq2y_West_EP[i] = new TProfile2D(ProName.Data(),ProName.Data(),3000,-0.5,2999.5,9,-0.5,8.5);// pos eta || x axis is RunIndex, y axis is Centrality

    ProName = Form("qx_2nd_Vertex_%s_Full",mVStr[i].Data());
    p_mq2x_Full_EP[i] = new TProfile2D(ProName.Data(),ProName.Data(),3000,-0.5,2999.5,9,-0.5,8.5);// x axis is RunIndex, y axis is Centrality
    ProName = Form("qy_2nd_Vertex_%s_Full",mVStr[i].Data());
    p_mq2y_Full_EP[i] = new TProfile2D(ProName.Data(),ProName.Data(),3000,-0.5,2999.5,9,-0.5,8.5);// x axis is RunIndex, y axis is Centrality
  }
}
...
void StVecMesonProManger::InitShift()
{
  for(Int_t i = 0; i < 2; i++) // vertex pos/neg
  {
    for(Int_t k = 0; k < 5; k++) // Shift Order
    {
      ...
      p_mcos2_East_EP[i][k] = new TProfile2D(ProName.Data(),ProName.Data(),3000,-0.5,2999.5,9,-0.5,8.5); // x axis is RunIndex, y axis is Centrality
      ProName = Form("SinPsi2_Vertex_%s_Order_%d_East",mVStr[i].Data(),k);
      p_msin2_East_EP[i][k] = new TProfile2D(ProName.Data(),ProName.Data(),3000,-0.5,2999.5,9,-0.5,8.5); // x axis is RunIndex, y axis is Centrality
      ProName = Form("CosPsi2_Vertex_%s_Order_%d_West",mVStr[i].Data(),k);
      p_mcos2_West_EP[i][k] = new TProfile2D(ProName.Data(),ProName.Data(),3000,-0.5,2999.5,9,-0.5,8.5); // x axis is RunIndex, y axis is Centrality
      ProName = Form("SinPsi2_Vertex_%s_Order_%d_West",mVStr[i].Data(),k);
      p_msin2_West_EP[i][k] = new TProfile2D(ProName.Data(),ProName.Data(),3000,-0.5,2999.5,9,-0.5,8.5); // x axis is RunIndex, y axis is Centrality

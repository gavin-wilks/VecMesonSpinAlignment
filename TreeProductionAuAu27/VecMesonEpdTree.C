...
void VecMesonEpdTree(const Char_t *inputFile="../../PidFlow/FileList/19p6GeV_2019/pico_prod_random_test.list", const Char_t *jobId = "lastbit", const Int_t Mode = 6, const Int_t energy = 4, const Int_t flag_ME = 0, const Int_t flag_PID = 0)
{
  ...
  //gSystem->Load("StEpdEpFinder");
  gSystem->Load("StEpdUtil");
  gSystem->Load("StVecMesonMaker");
  gSystem->Load("StVecMesonEpdMaker");
  ...
  StVecMesonEpdMaker *VecMesonMaker = new StVecMesonEpdMaker("VecMeson",picoMaker,jobId,Mode,energy,flag_ME,flag_PID);

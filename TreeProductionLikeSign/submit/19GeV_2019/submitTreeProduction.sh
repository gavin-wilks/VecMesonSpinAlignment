...
codePath=/star/u/gwilks3/Workspace/VectorMesonSpinAlignment/VecMesonSpinAlignment/TreeProductionLikeSign
...
##########Mode Selection##########
#mode=0
#outDir=ReCenterParameter_TPCOnly
...
#outDir=Phi/Forest/Phi${SM}_eta1p5_20240929_TPCOnly_cent2060_extrainfo
outDir=Phi/Forest/Phi${SM}_eta1p5_20241216_TPC_cent2060_extrainfo_70vz_25phipsi_LikeSign
#outDir=Phi/Forest/Phi${SM}_eta1_20240918_TPCTOF_cent2060_extrainfo
#outDir=Phi/Forest/Phi${SM}_eta1_20240808_PIDEff_DCA2_MoreEtaBins_NoPhiBins_Fixed

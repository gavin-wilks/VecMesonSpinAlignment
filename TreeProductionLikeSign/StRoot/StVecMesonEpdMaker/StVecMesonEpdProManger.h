#ifndef StVecMesonEpdProManger_h
#define StVecMesonEpdProManger_h
...
{
  public:
    StVecMesonEpdProManger();
    virtual ~StVecMesonEpdProManger();
    ...
    void InitD12();
    void FillD12(int, double, double);
    void WriteD12();
  ...
  private:
    ...
    ClassDef(StVecMesonEpdProManger,1)
};

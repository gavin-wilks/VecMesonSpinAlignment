...
codePath=/star/u/gwilks3/Workspace/VectorMesonSpinAlignment/VecMesonSpinAlignment/FillSpinAlignment2D
...
outDir=${pid}${SM}_EtaMode${etamode}_20241219_ptyspectra_TPCTOF_eta1_y1_nsig1_dipangle_LIKESIGN

...
void FillSpinAlignment(const char* list = "../FileLists/19GeV_2019/Phi_SE_eta1p5_cent2060_likesign_test.list", const char *jobId = "TESTING_TPCOnly_LikeSign", const Int_t energy = 4, const Int_t X_flag = 0, const Int_t mode = 0, const Int_t etamode = 0)
{

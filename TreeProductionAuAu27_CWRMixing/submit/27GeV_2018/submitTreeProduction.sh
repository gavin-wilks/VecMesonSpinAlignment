...
codePath=/star/u/gwilks3/Workspace/VectorMesonSpinAlignment/VecMesonSpinAlignment/TreeProductionAuAu27_CWRMixing
...
outDir=Phi/Forest/Phi${SM}_eta1_20240710_VzVzVpdCut_CWREventMixingMethod

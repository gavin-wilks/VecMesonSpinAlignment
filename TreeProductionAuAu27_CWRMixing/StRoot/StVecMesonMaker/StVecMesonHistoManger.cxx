...
void StVecMesonHistoManger::InitQA()
{
  ...
  h_mFullRaw = new TH1F("h_mFullRaw","h_mFullRaw",360,-TMath::Pi()/2.0,TMath::Pi()/2.0);
  h_mEastRaw = new TH1F("h_mEastRaw","h_mEastRaw",360,-TMath::Pi()/2.0,TMath::Pi()/2.0);
  h_mWestRaw = new TH1F("h_mWestRaw","h_mWestRaw",360,-TMath::Pi()/2.0,TMath::Pi()/2.0);
...
{
  h_mEastReCenter = new TH1F("h_mEastReCenter","h_mEastReCenter",360,-TMath::Pi()/2.0,TMath::Pi()/2.0);
  h_mWestReCenter = new TH1F("h_mWestReCenter","h_mWestReCenter",360,-TMath::Pi()/2.0,TMath::Pi()/2.0);
  h_mRanAReCenter = new TH1F("h_mRanAReCenter","h_mRanAReCenter",360,-TMath::Pi()/2.0,TMath::Pi()/2.0);
  h_mRanBReCenter = new TH1F("h_mRanBReCenter","h_mRanBReCenter",360,-TMath::Pi()/2.0,TMath::Pi()/2.0);
  h_mFullReCenter = new TH1F("h_mFullReCenter","h_mFullReCenter",360,-TMath::Pi()/2.0,TMath::Pi()/2.0);

  h_mEastShift = new TH1F("h_mEastShift","h_mEastShift",360,-TMath::Pi()/2.0,TMath::Pi()/2.0);
  h_mWestShift = new TH1F("h_mWestShift","h_mWestShift",360,-TMath::Pi()/2.0,TMath::Pi()/2.0);
  h_mRanAShift = new TH1F("h_mRanAShift","h_mRanAShift",360,-TMath::Pi()/2.0,TMath::Pi()/2.0);
  h_mRanBShift = new TH1F("h_mRanBShift","h_mRanBShift",360,-TMath::Pi()/2.0,TMath::Pi()/2.0);
  h_mFullShift = new TH1F("h_mFullShift","h_mFullShift",360,-TMath::Pi()/2.0,TMath::Pi()/2.0);
}

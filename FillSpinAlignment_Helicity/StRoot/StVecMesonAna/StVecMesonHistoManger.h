...
{
  public:
    StVecMesonHistoManger(Int_t EP_mode, Int_t study);
    ~StVecMesonHistoManger();

    void InitSys(Int_t X_flag, Int_t mode);
    void FillSys(Float_t pt, Float_t eta, Float_t p, Int_t cent9, Float_t CosThetaStar, Float_t CosThetaStarH, Float_t phihelicity, Float_t PhiPsi, Float_t Cos2PhiStarPhi, Int_t dcaSys, Int_t nSigSys, Float_t Res2, Float_t Mass2, Double_t reweight, Int_t X_flag, Int_t mode);

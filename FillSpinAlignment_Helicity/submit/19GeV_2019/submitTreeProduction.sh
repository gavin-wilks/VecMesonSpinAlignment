...
codePath=/star/u/gwilks3/Workspace/VectorMesonSpinAlignment/VecMesonSpinAlignment/FillSpinAlignment_Helicity
...
outDir=${pid}${SM}_EtaMode${etamode}_Study${study}_20241021_HelicitySpinAlignment_2D_OffDiag

...
#energy=1  # 19p6GeV
#library=SL21c
listPath=/star/u/gwilks3/Workspace/VectorMesonSpinAlignment/VecMesonSpinAlignment/FillSpinAlignment_Helicity/submit/19GeV_2019/hadd
...
outDir=${part}${SM}_etamode${etamode}_20240802_HelicitySpinAlignment_2D_RapidityDependence_Retry

...
#energy=1  # 19p6GeV
#library=SL21c
listPath=/star/u/gwilks3/Workspace/VectorMesonSpinAlignment/VecMesonSpinAlignment/FillSpinAlignmentAuAu27/submit/27GeV_2018/hadd
...
outDir=${part}${SM}_etamode${etamode}_20240516_NoVzVzVpdCut
outFile=Yields_${part}_${SM}_27GeV
##########Mode Selection##########

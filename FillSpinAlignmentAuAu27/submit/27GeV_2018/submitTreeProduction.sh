...
codePath=/star/u/gwilks3/Workspace/VectorMesonSpinAlignment/VecMesonSpinAlignment/FillSpinAlignmentAuAu27
...
energy=5  # 27GeV
library=SL19b
listPath=/star/u/gwilks3/Workspace/VectorMesonSpinAlignment/VecMesonSpinAlignment/FileLists/27GeV_2018
outPath=/gpfs01/star/scratch/gwilks3/VectorMesonSpinAlignment/AuAu27GeV_2018
##########Energy Selection##########
...
#outDir=${pid}${SM}_EtaMode${etamode}_20240516_NoVzVzVpdCut
outDir=${pid}${SM}_EtaMode${etamode}_20240712_NoPsi2Bin

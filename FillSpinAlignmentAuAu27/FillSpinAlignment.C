...
void FillSpinAlignment(const char* list = "../FileLists/200GeV_2014/PhiME_eta1_test.list", const char *jobId = "TESTING", const Int_t energy = 6, const Int_t X_flag = 1, const Int_t mode = 0, const Int_t etamode = 0)
{

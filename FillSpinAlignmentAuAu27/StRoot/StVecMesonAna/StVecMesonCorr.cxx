...
TString StVecMesonCorr::mVStr[2] = {"neg","pos"};
...
void StVecMesonCorr::InitResolution1Corr()
{
  ...
  if(mEnergy == 3) InPutFile_Res = Form("StRoot/Utility/EpdResolution/Resolution_file_%s_EpdCorrections_6.root",vmsa::mBeamEnergy[mEnergy].c_str());
  mInPutFile_Res = TFile::Open(InPutFile_Res.Data());

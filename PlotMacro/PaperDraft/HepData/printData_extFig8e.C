...
void printData_extFig8e()
{
  ...
  TGraphAsymmErrors *g_rhoCent_2nd_stat = (TGraphAsymmErrors*)File_InPut->Get("g_rhoCent_39GeV_2nd_stat");
  TGraphAsymmErrors *g_rhoCent_2nd_sys  = (TGraphAsymmErrors*)File_InPut->Get("g_rhoCent_39GeV_2nd_sys");

  const int centStart[4] = {60,40,20,0};
  const int centStop[4]  = {80,60,40,20};

  string outputfile = "/Users/xusun/WorkSpace/STAR/Data/SpinAlignment/PaperDraft/Nature/HepData/dataExtFig8e.txt";

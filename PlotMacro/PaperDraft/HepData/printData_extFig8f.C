...
void printData_extFig8f()
{
  ...
  TGraphAsymmErrors *g_rhoCent_2nd_stat = (TGraphAsymmErrors*)File_InPut->Get("g_rhoCent_54GeV_2nd_stat");
  TGraphAsymmErrors *g_rhoCent_2nd_sys  = (TGraphAsymmErrors*)File_InPut->Get("g_rhoCent_54GeV_2nd_sys");

  const int centStart[5] = {60,40,20,10,0};
  const int centStop[5]  = {80,60,40,20,10};

  string outputfile = "/Users/xusun/WorkSpace/STAR/Data/SpinAlignment/PaperDraft/Nature/HepData/dataExtFig8f.txt";

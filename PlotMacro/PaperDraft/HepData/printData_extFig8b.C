...
void printData_extFig8b()
{
  string inputfile = "/Users/xusun/WorkSpace/STAR/Data/SpinAlignment/PaperDraft/Nature/Phi/rhoCent_39GeV_LXaxis.root";
  TFile *File_InPut = TFile::Open(inputfile.c_str());
  TGraphAsymmErrors *g_rhoPhiCent_1st_stat = (TGraphAsymmErrors*)File_InPut->Get("g_rhoCent_39GeV_1st_stat");
  TGraphAsymmErrors *g_rhoPhiCent_1st_sys  = (TGraphAsymmErrors*)File_InPut->Get("g_rhoCent_39GeV_1st_sys");
  TGraphAsymmErrors *g_rhoPhiCent_2nd_stat = (TGraphAsymmErrors*)File_InPut->Get("g_rhoCent_39GeV_2nd_stat");
  TGraphAsymmErrors *g_rhoPhiCent_2nd_sys  = (TGraphAsymmErrors*)File_InPut->Get("g_rhoCent_39GeV_2nd_sys");

  const int centStart[9] = {0,5,10,20,30,40,50,60,70};
  const int centStop[9]  = {5,10,20,30,40,50,60,70,80};

  string outputfile = "/Users/xusun/WorkSpace/STAR/Data/SpinAlignment/PaperDraft/Nature/HepData/dataExtFig8b.txt";

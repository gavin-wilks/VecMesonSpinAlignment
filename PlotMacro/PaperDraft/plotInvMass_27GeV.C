...
void plotInvMass_27GeV()
{
  ...
  c_peak->SaveAs("/Users/xusun/WorkSpace/STAR/figures/SpinAlignment/PaperDraft/c_InvMass_27GeV.eps");
  c_peak->SaveAs("/Users/xusun/WorkSpace/STAR/figures/SpinAlignment/PaperProposal/c_InvMass_27GeV.png");
}

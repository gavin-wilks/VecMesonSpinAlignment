...
void plotQA_rho00Sys_EP(int energy = 4)
{
  string mBeamEnergy[7] = {"7GeV","11GeV","19GeV","27GeV","39GeV","62GeV","200GeV"};
  string inputfile = Form("/Users/xusun/WorkSpace/STAR/Data/SpinAlignment/AuAu%s/Phi/rho00/RawRhoPtSys_EP.root",mBeamEnergy[energy].c_str());
  ...
  for(int i_dca = 0; i_dca < 3; ++i_dca)
  {
	...
	{
	  string GraphName_Count = Form("rhoRaw_Centrality_9_2nd_Dca_%d_Sig_%d_Phi_Norm_%d_Sigma_%d_Count_EP",i_dca,i_sig,i_norm,i_sigma);
	  ...
	  string GraphName_Inte = Form("rhoRaw_Centrality_9_2nd_Dca_%d_Sig_%d_Phi_Norm_%d_Sigma_%d_Inte_EP",i_dca,i_sig,i_norm,i_sigma);
  ...
  string FigName = Form("/Users/xusun/WorkSpace/STAR/figures/SpinAlignment/AnalysisNote/RhoSig/c_rhoSys_AuAu%s_EP.eps",mBeamEnergy[energy].c_str());

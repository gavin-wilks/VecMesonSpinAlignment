...
void comEffMcPhi_EP(int energy = 6, int cent = 9)
{
  gStyle->SetOptDate(0);
  ...
  string input_first = Form("/Users/xusun/WorkSpace/STAR/Data/SpinAlignment/AuAu%s/Phi/Efficiency/Eff_%s_SingleKaon_second_2060_EP.root",vmsa::mBeamEnergy[energy].c_str(),vmsa::mBeamEnergy[energy].c_str());
  ...
  string input_second = Form("/Users/xusun/WorkSpace/STAR/Data/SpinAlignment/AuAu%s/Phi/Efficiency/Eff_%s_SingleKaon_second_2060.root",vmsa::mBeamEnergy[energy].c_str(),vmsa::mBeamEnergy[energy].c_str());
  ...
  leg->SetBorderSize(0);
  leg->SetFillColor(10);
  leg->AddEntry(h_mEff_first[0],"phi & plateau EP","p");
  ...
  string FigName = Form("/Users/xusun/WorkSpace/STAR/Data/SpinAlignment/AuAu%s/Phi/Efficiency/c_effAuAu%s_com_EP.eps",vmsa::mBeamEnergy[energy].c_str(),vmsa::mBeamEnergy[energy].c_str());

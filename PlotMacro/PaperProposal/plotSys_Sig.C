...
void plotSys_Sig(int energy = 2)
{
  ...
  string FigName = Form("/Users/xusun/WorkSpace/STAR/figures/SpinAlignment/PaperProposal/NewF_JHChen/c_SysSig_AuAu%dGeV.eps",mEnergy[energy]);

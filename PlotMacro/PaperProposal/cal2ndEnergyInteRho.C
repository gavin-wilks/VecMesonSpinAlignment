...
void cal2ndEnergyInteRho()
{
  const string mEnergy[5] = {"11GeV","19GeV","27GeV_2ndMean","39GeV","62GeV"};
  ...
  string GraphName_Default = Form("g_EP_2_eff_%d_Dca_%d_Sig_%d_Phi_Norm_%d_Sigma_2_Inte",eff_default,dca_default,sig_default,norm_default);
  ...
  string outputfile = "/Users/xusun/WorkSpace/STAR/Data/SpinAlignment/PaperProposal/SysErrors/NewF_JHChen/rho00_2ndEnergyInte.root";

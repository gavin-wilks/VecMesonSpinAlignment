...
void plotSysCent_Dca(int energy = 0, int order = 1, string correction = "AccRes", string etamode = "eta1_eta1")
{
  ...
  string FigName = Form("c_SysCentDca_AuAu%dGeV_order%d.pdf",mEnergy[energy],order);

...
void plotSys_Norm(int energy = 2)
{
  ...
  string FigName = Form("/Users/xusun/WorkSpace/STAR/figures/SpinAlignment/PaperProposal/NewF_JHChen/c_SysNorm_AuAu%dGeV.eps",mEnergy[energy]);

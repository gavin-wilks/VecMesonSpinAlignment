...
void plotSysY_Poly(int energy = 1, int order = 2, string correction = "AccRes", string etamode = "eta1_eta1")
{
  ...
  string FigName = Form("c_SysYPoly_AuAu%dGeV_order%d.pdf",mEnergy[energy],order);

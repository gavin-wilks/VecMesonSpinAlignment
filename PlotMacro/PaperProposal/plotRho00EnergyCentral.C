...
void plotRho00EnergyCentral()
{
  gStyle->SetOptDate(0);
  TFile *File_Input = TFile::Open("/Users/xusun/WorkSpace/STAR/Data/SpinAlignment/PaperProposal/EnergyDependenceCentral/rho00_Cent0010_LXaxis.root");
  TGraphAsymmErrors *g_rho_2nd_stat = (TGraphAsymmErrors*)File_Input->Get("g_rho_Cent0010_2nd_stat");
  TGraphAsymmErrors *g_rho_2nd_sys  = (TGraphAsymmErrors*)File_Input->Get("g_rho_Cent0010_2nd_sys");
  ...
  Draw_TGAE_Point_new_Symbol(80,0.36,0.0,0.0,0.0,0.0,29,kRed,1.8);
  ...
  plotTopLegend((char*)"Au+Au (0-10\% & |#eta| < 1)",0.45,0.30,0.04,1,0.0,42,1);
  plotTopLegend((char*)"#phi-meson (1.2 < p_{T}< 5.4 GeV/c)",0.4,0.25,0.04,1,0.0,42,1);

  c_rho00->SaveAs("/Users/xusun/WorkSpace/STAR/figures/SpinAlignment/PaperProposal/c_rhoCent0010_energy_BESII.eps");
  c_rho00->SaveAs("/Users/xusun/WorkSpace/STAR/figures/SpinAlignment/PaperProposal/c_rhoCent0010_energy_BESII.png");
}

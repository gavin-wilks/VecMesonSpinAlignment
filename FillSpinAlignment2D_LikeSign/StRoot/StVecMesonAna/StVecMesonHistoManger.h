...
class StVecMesonHistoManger
{
  public:
    ...
    void FillSys(Float_t pt, Float_t eta, Float_t phi, Int_t cent9, Float_t CosThetaStar, Float_t PhiPsi, Float_t Cos2PhiStarPhi, Float_t phiprime, Int_t dcaSys, Int_t nSigSys, Float_t Res2, Float_t Mass2, Double_t reweight, Int_t X_flag, Int_t mode);

...
codePath=/star/u/gwilks3/Workspace/VectorMesonSpinAlignment/VecMesonSpinAlignment/FillSpinAlignment2D_LikeSign
...
outDir=${pid}${SM}_EtaMode${etamode}_20241213_ptyspectra_TPCOnly_70vz_25phipsi_eta1_y1p5_LikeSign

...
codePath=/star/u/gwilks3/Workspace/VectorMesonSpinAlignment/VecMesonSpinAlignment/FillSpinAlignmentPhiStar
...
outDir=${pid}${SM}_EtaMode${etamode}_20240415_Cos2PhiStarPhi

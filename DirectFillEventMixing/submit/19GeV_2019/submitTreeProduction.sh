...
codePath=/star/u/gwilks3/Workspace/VectorMesonSpinAlignment/VecMesonSpinAlignment/DirectFillEventMixing
...
outDir=KStar/Forest/vz1psi1/${SM}

mkdir -p JOBS/report
mkdir -p JOBS/csh
mkdir -p JOBS/list

mkdir -p ${outPath}/Log/DirectFillEventMixing/${outDir}
mkdir -p ${outPath}/OutPut/DirectFillEventMixing/${outDir}

...
ClassImp(StVecMesonFillCorr)

TString StVecMesonFillCorr::mVStr[4] = {"neg70","neg30","pos30","pos70"};
TString StVecMesonFillCorr::mOrder = "2nd";
//--------------------------------------------------------
StVecMesonFillCorr::StVecMesonFillCorr(Int_t energy)
{
  mEnergy = energy;
}

StVecMesonFillCorr::~StVecMesonFillCorr()
{
}
//--------------------------------------------------------
// ReCenter Correction
void StVecMesonFillCorr::InitReCenterCorrection()
{
...
TVector2 StVecMesonFillCorr::getReCenterPar_East(Int_t Cent9, Int_t RunIndex, Int_t vz_sign)
{
...
TVector2 StVecMesonFillCorr::getReCenterPar_West(Int_t Cent9, Int_t RunIndex, Int_t vz_sign)
{
  Float_t mean_qx, mean_qy;
  TVector2 qVector(0.0,0.0);
...
TVector2 StVecMesonFillCorr::getReCenterPar_Full(Int_t Cent9, Int_t RunIndex, Int_t vz_sign)
{
  Float_t mean_qx, mean_qy;
  TVector2 qVector(0.0,0.0);
...
TVector2 StVecMesonFillCorr::calq2Vector(TLorentzVector lTrack)
{
...
Float_t StVecMesonFillCorr::getWeight(TLorentzVector lTrack)
{
...
//--------------------------------------------------------
// Shift Correction
void StVecMesonFillCorr::InitShiftCorrection()
{
...
bool StVecMesonFillCorr::passTrackEtaNumCut(Int_t NumTrackEast, Int_t NumTrackWest)
{
...
bool StVecMesonFillCorr::passTrackFullNumCut(Int_t NumTrackFull, Int_t NumTrackFull_East, Int_t NumTrackFull_West)
{
...
Float_t StVecMesonFillCorr::AngleShift(Float_t Psi_raw)
{
...
// 2nd
Float_t StVecMesonFillCorr::calShiftAngle2East_EP(TVector2 Q2Vector_East, Int_t runIndex, Int_t Cent9, Int_t vz_sign)
{
...
Float_t StVecMesonFillCorr::calShiftAngle2West_EP(TVector2 Q2Vector_West, Int_t runIndex, Int_t Cent9, Int_t vz_sign)
{
...
Float_t StVecMesonFillCorr::calShiftAngle2Full_EP(TVector2 Q2Vector_Full, Int_t runIndex, Int_t Cent9, Int_t vz_sign)
{
...
Float_t StVecMesonFillCorr::calShiftAngle2Full_EP(TVector2 Q2Vector_Full, Int_t runIndex, Int_t Cent9, Int_t vz_sign, TLorentzVector lTrack, bool UsedEP)
{
...
void StVecMesonFillCorr::InitResolutionCorr()
{
...
Float_t StVecMesonFillCorr::getResolution2_EP(Int_t Cent9)
{
...
Float_t StVecMesonFillCorr::getResolution2_Full_EP(Int_t Cent9)
{

...
#energy=1  # 19p6GeV
#library=SL21c
listPath=/star/u/gwilks3/Workspace/VectorMesonSpinAlignment/VecMesonSpinAlignment/FillSpinAlignmentInvMass/submit/14GeV_2019/hadd
...
outDir=${part}${SM}_etamode${etamode}_InvMass_20231025

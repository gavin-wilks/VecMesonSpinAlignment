...
#./submitTreeProduction.sh 4 2 5 0.3333
...
do
  ...
  #for i in 0.2333 0.2667 0.3000 0.3667 0.4000 0.4333 
  for i in 0.2333 0.2667 0.3000 0.3333 0.3667 0.4000 0.4333 
  do 
    ./submitTreeProduction.sh 5 2 5 ${i} 0.0 0.0 0.0 0.0 ${v2}
  done
  
  for i in -0.3 -0.2 -0.1 0.1 0.2 0.3
  do 
    ./submitTreeProduction.sh 5 2 5 0.3333 ${i} 0.0 0.0 0.0 ${v2} 
  done
  
  for i in -0.3 -0.2 -0.1 0.1 0.2 0.3
  do 
    ./submitTreeProduction.sh 5 2 5 0.3333 0.0 ${i} 0.0 0.0 ${v2} 
  done
  
  for i in -0.3 -0.2 -0.1 0.1 0.2 0.3
  do 
    ./submitTreeProduction.sh 5 2 5 0.3333 0.0 0.0 ${i} 0.0 ${v2} 
  done
  
  for i in -0.3 -0.2 -0.1 0.1 0.2 0.3
  do 
    ./submitTreeProduction.sh 5 2 5 0.3333 0.0 0.0 0.0 ${i} ${v2} 
  done

done
#./submitTreeProduction.sh 5 2 5 0.3333 0.0 -0.3 0.0 0.0 0.2667 
#./submitTreeProduction.sh 5 2 5 0.3333 0.0 0.0 0.0 0.2 0.2333

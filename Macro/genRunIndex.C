...
#include <algorithm>
#include <iterator>
//#include "../TreeProduction/StRoot/Utility/StSpinAlignmentCons.h"
#include "../TreeProductionAuAu27/StRoot/Utility/StSpinAlignmentCons.h"

int genRunIndex(int energy = 6)
{
  ...
  string inputfile = Form("/star/u/gwilks3/Workspace/VectorMesonSpinAlignment/VecMesonSpinAlignment/FileListGenerators/%s_%d/runNumber_prod.list",vmsa::mBeamEnergy[energy].c_str(),vmsa::mBeamYear[energy]);
  ...
  std::string outputfile = Form("runIndex_%s_%d.txt",vmsa::mBeamEnergy[energy].c_str(),vmsa::mBeamYear[energy]);

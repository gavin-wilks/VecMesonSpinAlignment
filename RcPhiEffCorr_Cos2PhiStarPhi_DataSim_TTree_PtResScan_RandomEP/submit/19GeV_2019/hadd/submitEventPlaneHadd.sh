...
#energy=1  # 19p6GeV
#library=SL21c
listPath=/star/u/gwilks3/Workspace/VectorMesonSpinAlignment/VecMesonSpinAlignment/RcPhiEffCorr_Cos2PhiStarPhi_DataSim_TTree_PtResScan_Data/submit/19GeV_2019/hadd
...
SM=SE
outDir=${part}
outFile=Eff_20250908_19GeV_SingleKaon_2060
##########Mode Selection##########

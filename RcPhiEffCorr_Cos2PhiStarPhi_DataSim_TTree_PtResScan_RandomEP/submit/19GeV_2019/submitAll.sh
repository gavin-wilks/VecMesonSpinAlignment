...
#  for j in {2..5}
#  do 
#    ./submitTreeProduction.sh 100.0 100.0 10 10  ${i} ${j} 0 100
#  done
#done

#./submitTreeProduction.sh 100.0 100.0 10 10 5 2 0 1 100
#./submitTreeProduction.sh 100.0 100.0 10 10 5 3 0 1 100
#./submitTreeProduction.sh 100.0 100.0 10 10 5 4 0 1 200
#./submitTreeProduction.sh 100.0 100.0 10 10 5 5 0 1 300
#order=$1
#inputpt=$2
#startpt=$3
#njobs=$4
...
do 
  ...
  do
    ...
    do
      ...
      for icent in 10
      do
        for rho00 in -0.03 -0.02 -0.01 0.0 0.01 0.02 0.03
        do 
          ./submitTreeProduction.sh ${iorder} 5 ${icent} 500 0 ${istudy} ${imethod} ${rho00} 0.0
        done
        for rerho1n1 in -0.03 -0.02 -0.01 0.01 0.02 0.03
        do 
          ./submitTreeProduction.sh ${iorder} 5 ${icent} 500 0 ${istudy} ${imethod} 0.0 ${rerho1n1}
        done
      done
    done 
  done
...
#      for icent in {2..5}
#      do
#        ./submitTreeProduction.sh ${iorder} 5 ${icent} 0 1 50 0 ${istudy} ${imethod} 
#      done
#    done 
#  done
#done 
#
#./submitTreeProduction.sh 100.0 100.0 5 2 1 1 18
#./submitTreeProduction.sh 100.0 100.0 5 3 1 1 18
#./submitTreeProduction.sh 100.0 100.0 5 4 1 1 118
#./submitTreeProduction.sh 100.0 100.0 5 5 1 1 218

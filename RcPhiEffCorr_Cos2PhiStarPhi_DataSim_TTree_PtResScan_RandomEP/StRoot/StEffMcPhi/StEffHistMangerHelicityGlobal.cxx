  ...
  for(Int_t i_pt_phi = mpt_first-2; i_pt_phi <= mpt_last-2; ++i_pt_phi) // use rebinned pt
  {
    for(Int_t i_pt = data_constants::phi_pt_start[i_pt_phi]; i_pt <= data_constants::phi_pt_stop[i_pt_phi]; i_pt++)
    {
      for(Int_t i_phi = 0; i_phi < 10; i_phi++)
      {
        ...
        h_mPhi_MC[KEY_MC] = new TH2D(KEY_MC.Data(),KEY_MC.Data(),data_constants::kaon_azimuthal_bins*6,-TMath::Pi(),TMath::Pi(),data_constants::kaon_rapidity_bins*3,-1,1);
        ...
        h_mPhi_RC[KEY_RC] = new TH2D(KEY_RC.Data(),KEY_RC.Data(),data_constants::kaon_azimuthal_bins*6,-TMath::Pi(),TMath::Pi(),data_constants::kaon_rapidity_bins*3,-1,1);
        h_mPhi_RC[KEY_RC]->Sumw2();
        //std::cout << "INITIALIZED: " << KEY_RC << std::endl;
      }

      TString KEY_MC = Form("mcphi_phistarphi_phipt_%d",i_pt);
      h_mPhi_MC[KEY_MC] = new TH2D(KEY_MC.Data(),KEY_MC.Data(),data_constants::kaon_azimuthal_bins*6,-TMath::Pi(),TMath::Pi(),data_constants::kaon_azimuthal_bins*6,-TMath::Pi(),TMath::Pi());
      h_mPhi_MC[KEY_MC]->Sumw2();
      //std::cout << "INITIALIZED: " << KEY_MC << std::endl;
      TString KEY_RC = Form("rcphi_phistarphi_phipt_%d",i_pt);
      h_mPhi_RC[KEY_RC] = new TH2D(KEY_RC.Data(),KEY_RC.Data(),data_constants::kaon_azimuthal_bins*6,-TMath::Pi(),TMath::Pi(),data_constants::kaon_azimuthal_bins*6,-TMath::Pi(),TMath::Pi());
      h_mPhi_RC[KEY_RC]->Sumw2();
      //std::cout << "INITIALIZED: " << KEY_RC << std::endl;

      KEY_MC = Form("mcphi_phistarmphi_phipt_%d",i_pt);
      h_mPhi1D_MC[KEY_MC] = new TH1D(KEY_MC.Data(),KEY_MC.Data(),data_constants::kaon_azimuthal_bins*6,-2*TMath::Pi(),2*TMath::Pi());
      h_mPhi1D_MC[KEY_MC]->Sumw2();
      //std::cout << "INITIALIZED: " << KEY_MC << std::endl;
      KEY_RC = Form("rcphi_phistarmphi_phipt_%d",i_pt);
      h_mPhi1D_RC[KEY_RC] = new TH1D(KEY_RC.Data(),KEY_RC.Data(),data_constants::kaon_azimuthal_bins*6,-2*TMath::Pi(),2*TMath::Pi());
  ...
  for(Int_t i_pt_phi = mpt_first-2; i_pt_phi <= mpt_last-2; ++i_pt_phi) // use rebinned pt
  {
    for(Int_t i_phi = 0; i_phi < 10; i_phi++)
    {
      for(Int_t i_pt_kaon = 0; i_pt_kaon < data_constants::kaon_pt_bins; i_pt_kaon++)
      {
        ...
        h_mKaon_MC[KEY_MC] = new TH2D(KEY_MC.Data(),KEY_MC.Data(),data_constants::kaon_azimuthal_bins*10,-TMath::Pi(),TMath::Pi(),data_constants::kaon_rapidity_bins*2,-data_constants::kaon_rapidity_max,data_constants::kaon_rapidity_max);
        h_mKaon_MC[KEY_MC]->Sumw2();                                                                                                                                                                    
        //std::cout << "INITIALIZED: " << KEY_MC << std::endl;                                                                                                                                            
        TString KEY_RC = Form("rckaon_phipt_%d_cos2phistarphi_%d_kaonpt_%d",i_pt_phi,i_phi,i_pt_kaon);                                                                                                  
        h_mKaon_RC[KEY_RC] = new TH2D(KEY_RC.Data(),KEY_RC.Data(),data_constants::kaon_azimuthal_bins*10,-TMath::Pi(),TMath::Pi(),data_constants::kaon_rapidity_bins*2,-data_constants::kaon_rapidity_max,data_constants::kaon_rapidity_max);
      ...
      h_mKaon_MC[KEY_MC1] = new TH2D(KEY_MC1.Data(),KEY_MC1.Data(),data_constants::kaon_azimuthal_bins*6,-0.6,0.6,data_constants::kaon_rapidity_bins*3,-0.6,0.6);
      ...
      h_mKaon_RC[KEY_RC1] = new TH2D(KEY_RC1.Data(),KEY_RC1.Data(),data_constants::kaon_azimuthal_bins*6,-0.6,0.6,data_constants::kaon_rapidity_bins*3,-0.6,0.6);
      ...
      h_mKaon_MC[KEY_MC1] = new TH2D(KEY_MC1.Data(),KEY_MC1.Data(),720,0.0,2.0*TMath::Pi(),200,0.0,0.9);
      h_mKaon_MC[KEY_MC1]->Sumw2();
      //std::cout << "INITIALIZED: " << KEY_MC1 << std::endl;
      KEY_RC1 = Form("rckaon_deltarphi_phipt_%d_cos2phistarphi_%d",i_pt_phi,i_phi);
      h_mKaon_RC[KEY_RC1] = new TH2D(KEY_RC1.Data(),KEY_RC1.Data(),720,0.0,2.0*TMath::Pi(),200,0.0,0.9);
      h_mKaon_RC[KEY_RC1]->Sumw2();
      //std::cout << "INITIALIZED: " << KEY_RC1 << std::endl;
      KEY_MC1 = Form("mckaonplusphi_delta_phipt_%d_cos2phistarphi_%d",i_pt_phi,i_phi);
      h_mKaon_MC[KEY_MC1] = new TH2D(KEY_MC1.Data(),KEY_MC1.Data(),data_constants::kaon_azimuthal_bins*6,-0.5,0.5,data_constants::kaon_rapidity_bins*3,-0.4,0.4);
      h_mKaon_MC[KEY_MC1]->Sumw2();
      //std::cout << "INITIALIZED: " << KEY_MC1 << std::endl;
      KEY_RC1 = Form("rckaonplusphi_delta_phipt_%d_cos2phistarphi_%d",i_pt_phi,i_phi);
      h_mKaon_RC[KEY_RC1] = new TH2D(KEY_RC1.Data(),KEY_RC1.Data(),data_constants::kaon_azimuthal_bins*6,-0.5,0.5,data_constants::kaon_rapidity_bins*3,-0.4,0.4);
      h_mKaon_RC[KEY_RC1]->Sumw2();
      //std::cout << "INITIALIZED: " << KEY_RC1 << std::endl;
...
void StEffHistMangerHelicityGlobal::InitHist(int bincos = 20, int binphi = 20, int study = 0)
{
  mStudy = study;
  const int studyn[3] = {4,9,10};
  float studymin[3] = {1.2,-0.5,-1.0};
  float studymax[3] = {5.4,8.5,1.0};

  double cosedge[(const int) bincos + 1];
  double phiedge[(const int) binphi + 1];

  const int ptresbin = 60;
  double ptresedge[ptresbin+1];
  for(int ires = 0; ires < ptresbin+1; ires++)
  {
    ptresedge[ires] = 0.1*double(ires-ptresbin/2)/double(ptresbin/2);
    cout << "ires = " << ires << ", ptresedge[ires] = " << ptresedge[ires] << endl;
  }
 
  for(int icos = 0; icos < bincos+1; icos++)
  {
    cosedge[icos] = double(icos-bincos/2)/double(bincos/2);
    cout << "icos = " << icos << ", cosedge[icos] = " << cosedge[icos] << endl;
  }
  for(int iphi = 0; iphi < binphi+1; iphi++)
  {
    phiedge[iphi] = double(iphi)*TMath::Pi()*2./double(binphi);
    cout << "iphi = " << iphi << ", phiedge[iphi] = " << phiedge[iphi] << endl;
  }
  double studyedge[studyn[study]+1];
  if(study == 0)
  {
    studyedge[0] = 1.2;
    studyedge[1] = 1.8;
  ...
  //for(int iy = 0; iy < studyn[mStudy]; iy++) 
  //{
  //  //h_mPhiMassMC[iy] = new TH1D(Form("phimassMC_y%d",iy),Form("phimassMC_y%d",iy),200,0.98,1.05);
  //  for(int iptres = 41; iptres < 42; iptres++)
  //  //for(int iptres : {0,20,21} )
  //  {
  //    h_mPhiMass[iy][iptres] = new TH1D(Form("phimass_%d_ptsmear%d",iy,iptres),Form("phimass_%d_ptsmear%d",iy,iptres),50,0.98,1.05);
  //    h_mPhiMass[iy][iptres]->Sumw2();
  //    if(iy == 0) 
  //    {
  //      h_mPtRes[0][iptres] = new TH2D(Form("ptres_kplus_ptsmear%d",iptres),Form("ptres_kplus_ptsmear%d",iptres),studyn[mStudy],studyedge,ptresbin,ptresedge);
  //      h_mPtRes[0][iptres]->Sumw2();
  //      h_mPtRes[1][iptres] = new TH2D(Form("ptres_kminus_ptsmear%d",iptres),Form("ptres_kminus_ptsmear%d",iptres),studyn[mStudy],studyedge,ptresbin,ptresedge);
  //      h_mPtRes[1][iptres]->Sumw2();
  //    }
  //  }
  //}
  for(int icut = 0; icut < 3; icut++)
  {
    string HistName = Form("random_cut_%d",icut);
    h3_Random[icut] = new TH3D(HistName.c_str(),HistName.c_str(),studyn[mStudy],studyedge,bincos,cosedge,bincos,cosedge);
    h3_Random[icut]->Sumw2();
  }
  for(int iv2 = 0; iv2 < 1; iv2++)
  {
    for(int iep = 0; iep < 2; iep++)
    {
      string HistName = Form("h3_mMcEffCosPhiPrimeYSmearMC_epsmear_%d",iep);
      h3_mMcEffCosPhiPrimeYCuts_SmearMC[iep] = new TH3D(HistName.c_str(),HistName.c_str(),studyn[mStudy],studyedge,bincos,cosedge,binphi,phiedge);
      h3_mMcEffCosPhiPrimeYCuts_SmearMC[iep]->Sumw2();
    }
    for(int iptres = 41; iptres < 42; iptres++)
    { 
      for(int iep = 1; iep < 2; iep++)
      {
        ...
        {
          string HistName = Form("h3_mMcEffCosPhiPrimeYSmear_cut%d_epsmear_%d_ptsmear_%d",icut,iep,iptres);
          h3_mMcEffCosPhiPrimeYCuts_Smear_Cut[icut][iptres] = new TH3D(HistName.c_str(),HistName.c_str(),studyn[mStudy],studyedge,bincos,cosedge,binphi,phiedge);
          h3_mMcEffCosPhiPrimeYCuts_Smear_Cut[icut][iptres]->Sumw2();
        }
      }    
    }
  }
...
void StEffHistMangerHelicityGlobal::FillPhiHistMc(int cent, double pt, double phi, double y, double phistar, double cos, double cosH, double kpt, double ky)
{
    ...
    if(pt >= mpt_low[i_pt] && pt < mpt_up[i_pt])
    {
      ...
      for(int i_pt_hist = data_constants::phi_pt_start[phi_pt_bin]; i_pt_hist <= data_constants::phi_pt_stop[phi_pt_bin]; i_pt_hist++)
      {
        ...
        { 
          ...
          for(Int_t i_phi = 0; i_phi < 10; i_phi++)
          {
            //std::cout << "Cos2PhiStarPhi = " << Cos2PhiStarPhi << ", (double(i_phi)-5.)/5. = " << (double(i_phi)-5.)/5. << ", (double(i_phi)-4.)/5. = " << (double(i_phi)-4.)/5 << std::endl;
            if(Cos2PhiStarPhi >= (double(i_phi)-5.)/5. && Cos2PhiStarPhi < (double(i_phi)-4.)/5.)
            {
...
void StEffHistMangerHelicityGlobal::FillPhiHistRc(int cent, double pt, double phi, double y, double phistar, double cos, double cosH, double kpt, double ky)
{
  if(cent < vmsa::cent_low[0] || cent > vmsa::cent_up[0]) return;
  double  ratio_weight = 1.0; //h_mSpectraRatio->GetBinContent(h_mSpectraRatio->FindBin(pt,y));
...
void StEffHistMangerHelicityGlobal::FillKaonHistMc(int cent, double phi, double pt, double y, double kpt, double ky, double keta, double kphi, double phistar, double cos, double cosH)
{
  if(cent < vmsa::cent_low[0] || cent > vmsa::cent_up[0]) return;
  double  ratio_weight = 1.0;//h_mSpectraRatio->GetBinContent(h_mSpectraRatio->FindBin(pt,y));
...
void StEffHistMangerHelicityGlobal::FillKaonDeltaHistMc(int cent, double phi, double eta, double pt, double y, double kppt, double kpeta, double kpphi, double kmpt, double kmeta, double kmphi, double phistar)
{
  if(cent < vmsa::cent_low[0] || cent > vmsa::cent_up[0]) return;
  double  ratio_weight = 1.0;//h_mSpectraRatio->GetBinContent(h_mSpectraRatio->FindBin(pt,y));

  double Cos2PhiStarPhi = TMath::Cos(2.0*(phistar-phi));
  double phiphidiffp = phi-kpphi;
  double phietadiffp = eta-kpeta;
  double phiphidiffm = phi-kmphi;
  double phietadiffm = eta-kmeta;
  double phidiff = kpphi-kmphi;
  double etadiff = kpeta-kmeta;
  ...
  double deltar = TMath::Sqrt(etadiff*etadiff+phidiff*phidiff);
  double phi_r = TMath::ATan2(etadiff,phidiff);
...
void StEffHistMangerHelicityGlobal::FillKaonHistRc(int cent, double phi, double pt, double y, double kpt, double ky, double keta, double kphi, double phistar, double cos, double cosH)
{
  if(cent < vmsa::cent_low[0] || cent > vmsa::cent_up[0]) return;
  double  ratio_weight = 1.0; //h_mSpectraRatio->GetBinContent(h_mSpectraRatio->FindBin(pt,y));
...
void StEffHistMangerHelicityGlobal::FillKaonDeltaHistRc(int cent, double phi, double eta, double pt, double y, double kppt, double kpeta, double kpphi, double kmpt, double kmeta, double kmphi, double phistar)
{
  if(cent < vmsa::cent_low[0] || cent > vmsa::cent_up[0]) return;
  double  ratio_weight =1.0;// h_mSpectraRatio->GetBinContent(h_mSpectraRatio->FindBin(pt,y));
...
void StEffHistMangerHelicityGlobal::FillPhiMassMC(int ybin, double phimass, double weight)
{
  h_mPhiMassMC[ybin]->Fill(phimass,weight);
}
void StEffHistMangerHelicityGlobal::FillPhiMass(int ybin, double phimass, int iptres, double weight)
{
  h_mPhiMass[ybin][iptres]->Fill(phimass,weight);
}
void StEffHistMangerHelicityGlobal::FillPtRes(int charge, int cent, double pt, double rapidity, double ptres, int iptres, double weight)
{
  if(mStudy == 0) h_mPtRes[charge][iptres]->Fill(pt,ptres,weight);
  if(mStudy == 1) h_mPtRes[charge][iptres]->Fill(cent,ptres,weight);
  if(mStudy == 2) h_mPtRes[charge][iptres]->Fill(rapidity,ptres,weight);
}

void StEffHistMangerHelicityGlobal::FillHistMc(int cent, double pt, double y, double phi, double cos, double Psi, double phistar, double phiprime, double kpt, double ky, double cosH, double phiprimeH, double weight, int iv2, int irhoinput, int irho, int ieta, int ipt)
{
...
void StEffHistMangerHelicityGlobal::FillHistCut(int cent, double pt, double y, double phi, double cos, double Psi, double phistar, double phiprime, double kpt, double ky, double cosH, double phiprimeH, double weight, int iv2, int irhoinput, int irho, int ieta, int ipt, int cut)
{
  h3_mMcEffCosPhiPrimeYCuts[cut][irhoinput][irho][ieta][ipt]->Fill(y,TMath::Abs(cos),phiprime,weight);
}

void StEffHistMangerHelicityGlobal::FillHistRandom(int cut, int cent, double pt, double y, double cosep, double cosrand, double weight)
{
  if(mStudy == 0) h3_Random[cut]->Fill(pt,cosep,cosrand,weight);
  if(mStudy == 1) h3_Random[cut]->Fill(cent,cosep,cosrand,weight);
  if(mStudy == 2) h3_Random[cut]->Fill(y,cosep,cosrand,weight);
}

void StEffHistMangerHelicityGlobal::FillHistCutSmearMC(int cent, double pt, double y, double cos, double phiprime, double weight, int cut, int iep, int iptres)
{
  if(mStudy == 0) h3_mMcEffCosPhiPrimeYCuts_SmearMC[iep]->Fill(pt,cos,phiprime,weight);
  if(mStudy == 1) h3_mMcEffCosPhiPrimeYCuts_SmearMC[iep]->Fill(cent,cos,phiprime,weight);
  if(mStudy == 2) h3_mMcEffCosPhiPrimeYCuts_SmearMC[iep]->Fill(y,cos,phiprime,weight);
}
void StEffHistMangerHelicityGlobal::FillHistCutSmear(int cent, double pt, double y, double cos, double phiprime, double weight, int cut, int iep, int iptres)
{
  //h3_mMcEffCosPhiPrimeYCuts_Smear[irhoinput][irho][iptres]->Fill(y,cos,phiprime,weight);
  if(mStudy == 0) h3_mMcEffCosPhiPrimeYCuts_Smear_Cut[cut][iptres]->Fill(pt,cos,phiprime,weight);
  if(mStudy == 1) h3_mMcEffCosPhiPrimeYCuts_Smear_Cut[cut][iptres]->Fill(cent,cos,phiprime,weight);
  if(mStudy == 2) h3_mMcEffCosPhiPrimeYCuts_Smear_Cut[cut][iptres]->Fill(y,cos,phiprime,weight);
}
void StEffHistMangerHelicityGlobal::FillAngleSmear(int cent, double y, double cosrc, double cosmc, double phiprimerc, double phiprimemc, double weight, int irhoinput, int irho, int cut, int iep, int iptres)
{
  //h3_mMcEffCosPhiPrimeYCuts_Smear[irhoinput][irho][iptres]->Fill(y,cos,phiprime,weight);
  double betadiff = phiprimerc-phiprimemc;
  while(betadiff < -TMath::Pi()) betadiff += 2.0*TMath::Pi();
  while(betadiff >= TMath::Pi()) betadiff -= 2.0*TMath::Pi();
  
  h3_mAngleSmear[irhoinput][irho]->Fill(y,cosrc-cosmc,betadiff,weight);
  h3_mAngleSmearCos[irhoinput][irho]->Fill(y,cosmc,cosrc-cosmc,weight);
  h3_mAngleSmearBeta[irhoinput][irho]->Fill(y,phiprimemc,betadiff,weight);
  h3_mAngleSmearCosBeta[irhoinput][irho]->Fill(y,phiprimemc,cosrc-cosmc,weight);
  h3_mAngleSmearBetaCos[irhoinput][irho]->Fill(y,cosmc,betadiff,weight);
}

void StEffHistMangerHelicityGlobal::FillHistRc(int cent, double pt, double y, double phi, double cos, double Psi, double phistar, double phiprime, double kpt, double ky, double cosH)
{
  double  ratio_weight = 1.0;//h_mSpectraRatio->GetBinContent(h_mSpectraRatio->FindBin(pt,y));
  ...
  //double phi_shift = AngleShift(phi-Psi2);
...
double StEffHistMangerHelicityGlobal::AngleShift(double phi)
{
...
void StEffHistMangerHelicityGlobal::WriteHist()
{
  ...
  for(int icut = 0; icut < 3; icut++)
  {
    h3_Random[icut]->Write();
  }
  //for(int iy = 0; iy < studyn[mStudy]; iy++) 
  //{
  //  //h_mPhiMassMC[iy]->Write();
  //  for(int iptres = 41; iptres < 42; iptres++)
  //  {
  //    h_mPhiMass[iy][iptres]->Write();
  //    if(iy == 0) 
  //    {
  //      h_mPtRes[0][iptres]->Write();
  //      h_mPtRes[1][iptres]->Write();
  //    }
  //  }
  //}
  //      
  for(int iv2 = 0; iv2 < 1; iv2++)
  {
    for(int iep = 0; iep < 2; iep++)
    {
      h3_mMcEffCosPhiPrimeYCuts_SmearMC[iep]->Write();
    }
    for(int iptres = 41; iptres < 42; iptres++)
    {
      for(int iep = 1; iep < 2; iep++)
      {
        //h3_mMcEffCosPhiPrimeYCuts_Smear[irhoinput][irho][iptres]->Write();
        for(int icut = 0; icut < 2; icut++)
        {
          h3_mMcEffCosPhiPrimeYCuts_Smear_Cut[icut][iptres]->Write();
        }
      }
    }
  }

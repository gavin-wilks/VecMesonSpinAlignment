...
codePath=/star/u/gwilks3/Workspace/VectorMesonSpinAlignment/VecMesonSpinAlignment/FillSpinAlignmentKaonToFMatching
...
outDir=${pid}${SM}_EtaMode${etamode}_20241219_cent2060_kaonspectra_TTrees_TPCTOF_Retry_ToFTagging_dipangle

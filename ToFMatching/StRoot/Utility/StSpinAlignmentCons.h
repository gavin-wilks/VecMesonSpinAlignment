...
namespace vmsa
{
  ...
  float const mDcaTrMax_pid[3] = {2.0,2.0,2.0}; // cuts for daughter pions and kaons to make mother particles
  float const mDcaTrMax_phi = 2.0;

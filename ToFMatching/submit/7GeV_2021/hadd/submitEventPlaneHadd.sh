...
#energy=1  # 19p6GeV
#library=SL21c
listPath=/star/u/gwilks3/Workspace/VectorMesonSpinAlignment/VecMesonSpinAlignment/ToFMatching/submit/7GeV_2021/hadd
...
outDir=ToFMatching_Fixed
outFile=file_7GeV_${outDir}
##########Mode Selection##########

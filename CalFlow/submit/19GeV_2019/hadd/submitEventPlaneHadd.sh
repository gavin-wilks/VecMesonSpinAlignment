...
#energy=1  # 19p6GeV
#library=SL21c
listPath=/star/u/gwilks3/Workspace/VectorMesonSpinAlignment/VecMesonSpinAlignment/CalFlow/submit/19GeV_2019/hadd
...
etamode=$2
outDir=Phi${SM}
outFile=FlowYields_Phi_${SM}_19GeV_EtaMode${etamode}
##########Mode Selection##########

mkdir -p ${outPath}/hadd/FlowYields/${outDir}
mkdir -p ${outPath}/hadd/FlowYieldsLog/${outDir}

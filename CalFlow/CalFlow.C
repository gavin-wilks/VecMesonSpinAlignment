...
void CalFlow(int energy = 4, int pid = 0, int year = 0)
{
  ...
  cy6->cd();
  string KEY_SE_QA = Form("pt_%d_Centrality_%d_PhiPsi_%d_2nd_Dca_0_Sig_0_%s_SE",6,9,3,vmsa::mPID[pid].c_str());
  h_mMass_SE[KEY_SE_QA]->DrawCopy("PE");

  string KEY_ME_QA = Form("pt_%d_Centrality_%d_PhiPsi_%d_2nd_Dca_0_Sig_0_%s_ME",6,9,3,vmsa::mPID[pid].c_str());
  ...
  cy7->cd();
  KEY_SE_QA = Form("pt_%d_Centrality_%d_PhiPsi_%d_2nd_Dca_0_Sig_0_%s_SE",7,9,3,vmsa::mPID[pid].c_str());
  h_mMass_SE[KEY_SE_QA]->DrawCopy("PE");

  KEY_ME_QA = Form("pt_%d_Centrality_%d_PhiPsi_%d_2nd_Dca_0_Sig_0_%s_ME",7,9,3,vmsa::mPID[pid].c_str());
  h_mMass_ME[KEY_ME_QA]->SetLineColor(2);
  h_mMass_ME[KEY_ME_QA]->SetFillColor(2);
  h_mMass_ME[KEY_ME_QA]->SetFillStyle(3002);
  h_mMass_ME[KEY_ME_QA]->DrawCopy("h same");
  ...
  cy5->cd();
  KEY_SE_QA = Form("pt_%d_Centrality_%d_PhiPsi_%d_2nd_Dca_0_Sig_0_%s_SE",5,9,3,vmsa::mPID[pid].c_str());
  h_mMass_SE[KEY_SE_QA]->DrawCopy("PE");

  KEY_ME_QA = Form("pt_%d_Centrality_%d_PhiPsi_%d_2nd_Dca_0_Sig_0_%s_ME",5,9,3,vmsa::mPID[pid].c_str());
  h_mMass_ME[KEY_ME_QA]->SetLineColor(2);
  h_mMass_ME[KEY_ME_QA]->SetFillColor(2);
  h_mMass_ME[KEY_ME_QA]->SetFillStyle(3002);
  h_mMass_ME[KEY_ME_QA]->DrawCopy("h same");
  ...
  for(int i_pt = vmsa::pt_start; i_pt < vmsa::pt_stop; i_pt++) // pt loop
  {
    ...
    string KEY_SE_QA = Form("pt_%d_Centrality_%d_PhiPsi_%d_2nd_Dca_0_Sig_0_%s_SE",i_pt,9,3,vmsa::mPID[pid].c_str());
    h_mMass_SE[KEY_SE_QA]->DrawCopy();

    string KEY_ME_QA = Form("pt_%d_Centrality_%d_PhiPsi_%d_2nd_Dca_0_Sig_0_%s_ME",i_pt,9,3,vmsa::mPID[pid].c_str());
    h_mMass_ME[KEY_ME_QA]->SetLineColor(2);
    h_mMass_ME[KEY_ME_QA]->SetFillColor(2);
    h_mMass_ME[KEY_ME_QA]->SetFillStyle(3002);
    h_mMass_ME[KEY_ME_QA]->DrawCopy("h same");
  ...
  for(int i_pt = vmsa::pt_rebin_first[energy]; i_pt < vmsa::pt_rebin_last[energy]; i_pt++) // pt loop
  {
    ...
    {
      string KEY_Yield_SE = Form("Yields_Centrality_%d_Dca_0_Sig_0_%s_SE",i_cent,vmsa::mPID[pid].c_str());
      ...
      string KEY_Yield_ME = Form("Yields_Centrality_%d_Dca_0_Sig_0_%s_ME",i_cent,vmsa::mPID[pid].c_str());
      ...
      string KEY_Yield = Form("Yields_Centrality_%d_Dca_0_Sig_0_%s_SM",i_cent,vmsa::mPID[pid].c_str());

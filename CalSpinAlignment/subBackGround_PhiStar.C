...
void subBackGround_PhiStar(int energy = 4, int pid = 0, int year = 0, string date = "20240216", bool random3D = false, int order = 2, string etamode = "eta1_eta1")
{
  std::string EP[2] = {"","2nd"};
...
//#endif
  ...
  string outputfile = Form("../output/AuAu%s/%s/Cos2PhiStarPhi_InvMassSubBg_%s.root",vmsa::mBeamEnergy[energy].c_str(),vmsa::mPID[pid].c_str(),etamode.c_str());

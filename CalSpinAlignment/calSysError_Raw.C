...
void calSysError_Raw(Int_t energy = 4, Int_t pid = 0, Int_t i_cent = 9, string correction = "Raw")
{
  ...
  TFile *besi = TFile::Open("../data/BESI/RawRhoPtSys.root");

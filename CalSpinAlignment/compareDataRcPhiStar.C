...
void compareDataRcPhiStar(Int_t energy = 4, Int_t pid = 0, Int_t i_cent = 9, string correction = "Raw", int order = 2, string etamode = "eta1_eta1", int yspectra = 24)//defaultF = 0 is BESII, defaultF = 1 is BESI
{

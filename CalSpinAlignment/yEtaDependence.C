...
void yEtaDependence(Int_t energy = 4, Int_t pid = 0, std::string setting = "AccRes")
{
  ...
  float after[4]     = {0.3471,0.3427,0.3376,0.3362}; // v2 on and pt on, Eff + Acc, then Res correction 0-80%
  float afterErr[4]  = {0.0015,0.0016,0.0019,0.0025}; // v2 on and pt on, Eff + Acc, then Res correction 0-80%
  float beforeCent[4]    = {0.3399,0.3441,0.3545,0.3810}; // 0-80%
  float beforeErrCent[4] = {0.0008,0.0009,0.0011,0.0014}; // 0-80%
  float afterCent[4]     = {0.3482,0.3432,0.3369,0.3360}; // v2 on and pt on, Eff then Acc+Res correction 0-80%

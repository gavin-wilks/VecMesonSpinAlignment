...
void subBackGround_Helicity(int energy = 4, int pid = 0, int year = 0, string date = "20240520", bool random3D = false, int order = 2, string etamode = "eta1_eta1")
{
  ...
  string InPutFile_SE = Form("../data/Yields_Phi_SE_%s_%s_%s_Helicity_ExactSameEvents.root",vmsa::mBeamEnergy[energy].c_str(),date.c_str(),etamode.c_str());
  ...
  string InPutFile_ME = Form("../data/Yields_Phi_ME_%s_%s_%s_Helicity_ExactSameEvents.root",vmsa::mBeamEnergy[energy].c_str(),date.c_str(),etamode.c_str());
...
//#endif
  ...
  string outputfile = Form("../output/AuAu%s/%s/InvMassSubBg_%s_Helicity.root",vmsa::mBeamEnergy[energy].c_str(),vmsa::mPID[pid].c_str(),etamode.c_str());

...
void calSpinAlignmentSysPhiCentPoly2Integration(int energy = 3, int pid = 0, int year = 0, bool random3D = false, int centQA = 4, int ptQA = 0, int dcaQA = 0, int nsigQA = 0, std::string etamode = "eta1_eta1")
{

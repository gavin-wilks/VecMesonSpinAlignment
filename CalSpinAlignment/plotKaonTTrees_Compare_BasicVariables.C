...
void plotKaonTTrees_Compare_BasicVariables(int energy = 4, bool datarcweight = false, int variable = 0, int axis=1, double low=-0.5, double high = 0.5, string kinematic = "0") 
{
    ...
    for (Long64_t i = 0; i < nentries; i++)
    {
      ...
      //switch(variable)  {
      //  case 0:
      //    ptyetaphi[0][mChargeSE]->Fill(mPtSE,mRapiditySE,mEtaSE,mPhiSE,mNHitsFitSE,mWeightSE);
      //    break;
      //  case 1:
      //    ptyetaphi[0][mChargeSE]->Fill(mPtSE,mRapiditySE,mEtaSE,mPhiSE,mNHitsMaxSE,mWeightSE);
      //    break;
      //  case 2:
      //    ptyetaphi[0][mChargeSE]->Fill(mPtSE,mRapiditySE,mEtaSE,mPhiSE,float(mNHitsFitSE)/float(mNHitsMaxSE),mWeightSE);
      //    break;
      //  case 3:
      //    ptyetaphi[0][mChargeSE]->Fill(mPtSE,mRapiditySE,mEtaSE,mPhiSE,mDEdxSE,mWeightSE);
      //    break;
      //  case 4:
      //    ptyetaphi[0][mChargeSE]->Fill(mPtSE,mRapiditySE,mEtaSE,mPhiSE,mDcaSE,mWeightSE);
      //    break;
      //}
      switch(variable)  {
        case 0:
          ptyetaphi[0][mChargeSE]->Fill(mPtSE,mRapiditySE,mPhiSE,mNHitsFitSE,mWeightSE);
          break;
        case 1:
          ptyetaphi[0][mChargeSE]->Fill(mPtSE,mRapiditySE,mPhiSE,mNHitsMaxSE,mWeightSE);
          break;
        case 2:
          ptyetaphi[0][mChargeSE]->Fill(mPtSE,mRapiditySE,mPhiSE,float(mNHitsFitSE)/float(mNHitsMaxSE),mWeightSE);
          break;
        case 3:
          ptyetaphi[0][mChargeSE]->Fill(mPtSE,mRapiditySE,mPhiSE,mDEdxSE,mWeightSE);
          break;
        case 4:
          ptyetaphi[0][mChargeSE]->Fill(mPtSE,mRapiditySE,mPhiSE,mDcaSE,mWeightSE);
          break;
      }
    }
    ...
    for (Long64_t i = 0; i < nentriesME; i++)
    {
      ...
      switch(variable)  {
        case 0:
          ptyetaphi[1][mChargeME]->Fill(mPtME,mRapidityME,mPhiME,mNHitsFitME,mWeightME);
          break;
        case 1:
          ptyetaphi[1][mChargeME]->Fill(mPtME,mRapidityME,mPhiME,mNHitsMaxME,mWeightME);
          break;
        case 2:
          ptyetaphi[1][mChargeME]->Fill(mPtME,mRapidityME,mPhiME,float(mNHitsFitME)/float(mNHitsMaxME),mWeightME);
          break;
        case 3:
          ptyetaphi[1][mChargeME]->Fill(mPtME,mRapidityME,mPhiME,mDEdxME,mWeightME);
          break;
        case 4:
          ptyetaphi[1][mChargeME]->Fill(mPtME,mRapidityME,mPhiME,mDcaME,mWeightME);
          break;
      }
    }
    ...
    for (Long64_t i = 0; i < nentriesEmbed; i++)
    {
      ...
      if(mRcExists && mPassTpc && mPassTof && mPassM2 && mPassNsig)    
      {
        ...
        switch(variable)  {
          case 0:
            ptyetaphi[3][0]->Fill(mRcPtP,mRcRapidityP,mRcPhiP,mNHitsFitP,mWeight*PhiWeight*DataRcWeightVal);
            ptyetaphi[3][1]->Fill(mRcPtM,mRcRapidityM,mRcPhiM,mNHitsFitM,mWeight*PhiWeight*DataRcWeightVal);
            break;
          case 1:
            ptyetaphi[3][0]->Fill(mRcPtP,mRcRapidityP,mRcPhiP,mNHitsMaxP,mWeight*PhiWeight*DataRcWeightVal);
            ptyetaphi[3][1]->Fill(mRcPtM,mRcRapidityM,mRcPhiM,mNHitsMaxM,mWeight*PhiWeight*DataRcWeightVal);
            break;
          case 2:
            ptyetaphi[3][0]->Fill(mRcPtP,mRcRapidityP,mRcPhiP,float(mNHitsFitP)/float(mNHitsMaxP),mWeight*PhiWeight*DataRcWeightVal);
            ptyetaphi[3][1]->Fill(mRcPtM,mRcRapidityM,mRcPhiM,float(mNHitsFitM)/float(mNHitsMaxM),mWeight*PhiWeight*DataRcWeightVal);
            break;
          case 3:
            ptyetaphi[3][0]->Fill(mRcPtP,mRcRapidityP,mRcPhiP,mDEdxP,mWeight*PhiWeight*DataRcWeightVal);
            ptyetaphi[3][1]->Fill(mRcPtM,mRcRapidityM,mRcPhiM,mDEdxM,mWeight*PhiWeight*DataRcWeightVal);
            break;
          case 4:
            ptyetaphi[3][0]->Fill(mRcPtP,mRcRapidityP,mRcPhiP,mDcaP,mWeight*PhiWeight*DataRcWeightVal);
            ptyetaphi[3][1]->Fill(mRcPtM,mRcRapidityM,mRcPhiM,mDcaM,mWeight*PhiWeight*DataRcWeightVal);
            break;
        }
      }
    }
    ...
    for(int ic = 0; ic < 2; ic++)
    {
      ...
      ptyetaphi[2][ic]->GetAxis(axis)->SetRange(y_min_bin,y_max_bin);
      ptyetaphi[3][ic]->GetAxis(axis)->SetRange(y_min_bin,y_max_bin);

      var[2][ic]         = (TH1F*) ptyetaphi[2][ic]->Projection(3);
      varpt[2][ic]       = (TH2F*) ptyetaphi[2][ic]->Projection(3,0);
      varrapidity[2][ic] = (TH2F*) ptyetaphi[2][ic]->Projection(3,1);
      varphi[2][ic]      = (TH2F*) ptyetaphi[2][ic]->Projection(3,2);

      var[3][ic]         = (TH1F*) ptyetaphi[3][ic]->Projection(3);
      varpt[3][ic]       = (TH2F*) ptyetaphi[3][ic]->Projection(3,0);
      varrapidity[3][ic] = (TH2F*) ptyetaphi[3][ic]->Projection(3,1);
      varphi[3][ic]      = (TH2F*) ptyetaphi[3][ic]->Projection(3,2);
    ...
    for(int im = 2; im < 4; im++)
    {
      for(int ic = 0; ic < 2; ic++)
      {
        ...
        c1->SaveAs(Form("figures/KaonTTrees/K%s_%s_%s_%s.pdf",charge[ic].c_str(),varfile[variable].c_str(),settingfile[im-2].c_str(),kinematic.c_str()));
      }
    }
    for(int ic = 0; ic < 2; ic++)
    {
      ...
      c1->SaveAs(Form("figures/KaonTTrees/K%s_%s_DataRCRatio_%s.pdf",charge[ic].c_str(),varfile[variable].c_str(),kinematic.c_str()));
    }
}

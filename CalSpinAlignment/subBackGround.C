...
void subBackGround(int energy = 6, int pid = 0, int year = 0, string date = "20240827", bool random3D = false, int order = 2, string etamode = "eta1_eta1")
{
...
//#endif
  ...
  string outputfile = Form("../output/AuAu%s/%s/InvMassSubBg_%s_NoPsi2Bin.root",vmsa::mBeamEnergy[energy].c_str(),vmsa::mPID[pid].c_str(),etamode.c_str());

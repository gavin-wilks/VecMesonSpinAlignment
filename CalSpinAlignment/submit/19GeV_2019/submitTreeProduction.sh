...
outDir=${pid}${SM}_EtaMode${etamode}_20241016_ProcessingKaonTTrees_PtYPhi_TPCOnly_BasicVariables

mkdir -p JOBS/report
mkdir -p JOBS/csh
mkdir -p JOBS/list

mkdir -p ${outPath}/Log/ProcessKaonTTrees/${outDir}
mkdir -p ${outPath}/OutPut/ProcessKaonTTrees/${outDir}

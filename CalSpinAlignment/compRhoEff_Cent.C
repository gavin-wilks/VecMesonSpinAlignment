...
void compRhoEff_Cent(Int_t energy = 4, Int_t pid = 0)
{
  string inputfileF0 = Form("../output/AuAu%s/%s/RhoCent_RawSysErrors.root",vmsa::mBeamEnergy[energy].c_str(),vmsa::mPID[pid].c_str());
  string inputfileF1 = Form("../output/AuAu%s/%s/RhoCent_EffSysErrors.root",vmsa::mBeamEnergy[energy].c_str(),vmsa::mPID[pid].c_str());
  string inputfileF2 = Form("../output/AuAu%s/%s/RhoCent_AccResSysErrors.root",vmsa::mBeamEnergy[energy].c_str(),vmsa::mPID[pid].c_str());

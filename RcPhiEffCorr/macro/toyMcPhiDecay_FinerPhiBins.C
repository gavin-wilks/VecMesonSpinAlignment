...
void toyMcPhiDecay_FinerPhiBins(const int energy = 4, int ptbin = 5, const int centrality = 5, const int pid = 0, const int NMax = 5000, int mode = 1, int fitmode = 0, const char* jobID = "20221209") 
{
  mNMax = NMax;
...
void getKinematics(TLorentzVector& lPhi, double const mass)
{
  ...
  double const y = gRandom->Uniform(-6.0,6.0);//Uniform(-vmsa::acceptanceRapidity, vmsa::acceptanceRapidity);

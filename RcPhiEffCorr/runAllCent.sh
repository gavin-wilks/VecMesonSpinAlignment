...
root4star -l -b -q EffMcPhi.C\(0,0,10000000000,0,0,1,4,0,2,\"noToF\",0,1,0.0,\"1000\",0.3333333,0.0,0.0,0.0\)
mv Eff_7GeV_SingleParticle_noToF_Mode1_EtaMode0_PtBins0_2.root order1/.
root4star -l -b -q EffMcPhi.C\(0,0,10000000000,0,0,1,4,0,2,\"noToF\",0,2,0.0,\"1000\",0.3333333,0.0,0.0,0.0\)
mv Eff_7GeV_SingleParticle_noToF_Mode1_EtaMode0_PtBins0_2.root order2/.
#root4star -l -b -q EffMcPhi.C\(0,0,10000000000,0,0,1,4,0,2,\"noToF\",0,2,0.0,\"1000\",0.3333333,0.0,0.0,0.0\)

...
void acceptanceQA_4th_Res_2D(const int energy = 4, const int pid = 0, bool doall = true, std::string res = "0p1", double resval = 0.1, int cut = 1, int method = 1) {
...
*/
  ...
  for(int irho = 0; irho < 5; irho++) 
  {
    ...
    Func_rho->FixParameter(3, Gval[irho]);

...
void calculateFPt_EPRes_EffAcc_Poly_Helicity2D_ImproveProj(const int energy = 4, const int pid = 0, bool doall = true, bool isBesI = false, bool random3D = false, int etamode = 0, int order = 2, int yspectra = 2, int EP = 0, int v2 = 1) {
            ...
            for(int i_sigma = vmsa::Sig_start; i_sigma < 1/*vmsa::Sig_stop*/; ++i_sigma)
            {
              for(int i_method = 1/*vmsa::Method_start*/; i_method < vmsa::Method_stop; ++i_method)
              {
                for(int i_poly = 0; i_poly < 1/*3*/; i_poly++)
                {
                  ...
                  string outputpdf = Form("figures/%s/%s/Pt1DCosHelicityEfficiencyCorrectedYields_SmallBins.pdf",vmsa::mPID[pid].c_str(),vmsa::mBeamEnergy[energy].c_str());
                  ...
                  outputpdf = Form("figures/%s/%s/Pt1DCosHelicityRawYields_SmallBins.pdf",vmsa::mPID[pid].c_str(),vmsa::mBeamEnergy[energy].c_str());
                  ...
                  outputpdf = Form("figures/%s/%s/Pt1DCosHelicityEfficiency_SmallBins.pdf",vmsa::mPID[pid].c_str(),vmsa::mBeamEnergy[energy].c_str());
                  outputstartpdf = Form("%s[",outputpdf.c_str());
                  outputstoppdf = Form("%s]",outputpdf.c_str());
                  ...
                  outputpdf = Form("figures/%s/%s/Pt1DPhiHelicityRawYields_SmallBins.pdf",vmsa::mPID[pid].c_str(),vmsa::mBeamEnergy[energy].c_str());
                  outputstartpdf = Form("%s[",outputpdf.c_str());
                  outputstoppdf = Form("%s]",outputpdf.c_str());
                  ...
                  outputpdf = Form("figures/%s/%s/Pt1DPhiHelicityEfficiency_SmallBins.pdf",vmsa::mPID[pid].c_str(),vmsa::mBeamEnergy[energy].c_str());
                  outputstartpdf = Form("%s[",outputpdf.c_str());
                  outputstoppdf = Form("%s]",outputpdf.c_str());
                  ...
                  outputpdf = Form("figures/%s/%s/Pt1DPhiHelicityEfficiencyCorrectedYields_SmallBins.pdf",vmsa::mPID[pid].c_str(),vmsa::mBeamEnergy[energy].c_str());
                  outputstartpdf = Form("%s[",outputpdf.c_str());
                  outputstoppdf = Form("%s]",outputpdf.c_str());
                  ...
                  outputpdf = Form("figures/%s/%s/Pt1DPhiHelicitRawYields_SmallBins.pdf",vmsa::mPID[pid].c_str(),vmsa::mBeamEnergy[energy].c_str());
                  outputstartpdf = Form("%s[",outputpdf.c_str());
                  outputstoppdf = Form("%s]",outputpdf.c_str());

...
TProfile *resolution;
TH1F *h_theta, *h_theta_star, *h_theta_star_before, *h_out1, *h_out2;
TProfile *cos2phi;
...
void McEtaF(int Nrho = 33,int SetPt=2, int energy = 4, int pid = 0, int cent = 9, int const NMax = 2000000)
{
...
//  f_v2   = readv2(6,pid,cent);
  ...
  f_y = new TF1("f_y","0 + exp(-100*x*x)", -2,2);

...
void acceptanceQA_4th_Res_v2test_v2vary(const int energy = 4, const int pid = 0, std::string res = "0p4", double resval = 0.4, int cut = 1, int method = 0, int v2 = 1, int fit2d = 0, int EP = 1, int etamode = 3, int ieta = 4) {
...
*/  
  ...
  std::string FigureName = Form("./figures/AcceptanceQA/noBeta_V2Vary_AcceptanceQAInput_EDGE_%s_RecoObs_v2%d_EPSmear%d_2d%d_%s%s_method%d_etamode%d_ieta%d.pdf",ytextfile.c_str(),v2,EP,fit2d,vmsa::mBeamEnergy[energy].c_str(),cutoption.c_str(),method,etamode,ieta);
  ...
  FigureName = Form("./figures/AcceptanceQA/noBeta_VaryV2_AcceptanceQAInput_ONLYRESCORR_EDGE_%s_RecoObs_v2%d_EPSmear%d_2d%d_%s%s_method%d_etamode%d_ieta%d.pdf",ytextfile.c_str(),v2,EP,fit2d,vmsa::mBeamEnergy[energy].c_str(),cutoption.c_str(),method,etamode,ieta);
  c_play3->SaveAs(FigureName.c_str());
  ...
  FigureName = Form("./figures/AcceptanceQA/noBeta_VaryV2_AcceptanceQADifferenceFromIdeal_%s_EDGE_v2%d_EPSmear%d_2d%d_%s%s_method%d_etamode%d_ieta%d.pdf",ytextfile.c_str(),v2,EP,fit2d,vmsa::mBeamEnergy[energy].c_str(),cutoption.c_str(),method,etamode,ieta);
  ...
  FigureName = Form("./figures/AcceptanceQA/noBeta_VaryV2_AcceptanceQADifferenceFromIdeal_ONLYRESCORR_EDGE_%s_v2%d_EPSmear%d_2d%d_%s%s_method%d_etamode%d_ieta%d.pdf",ytextfile.c_str(),v2,EP,fit2d,vmsa::mBeamEnergy[energy].c_str(),cutoption.c_str(),method,etamode,ieta);
  c_diffI->SaveAs(FigureName.c_str());
}
...
//  double order2 = (2.*As - F + As*F - 3.*G/2. + 3.*As*G/4.)*CosTheta*CosTheta;
//  double order4 = (-1.*As*F + 3.*G/4. - 3.*As*G/2.)*CosTheta*CosTheta*CosTheta*CosTheta;
//  double order6 = (3.*As*G/4.)*CosTheta*CosTheta*CosTheta*CosTheta*CosTheta*CosTheta;
//
//  //double result = order0 + order2 + order4 + order6;
//
//  return N*(order0 + order2 + order4 + order6);

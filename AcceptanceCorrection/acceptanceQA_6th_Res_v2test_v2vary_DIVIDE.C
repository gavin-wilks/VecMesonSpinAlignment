...
void acceptanceQA_6th_Res_v2test_v2vary_DIVIDE(const int energy = 4, const int pid = 0, std::string res = "0p4", double resval = 0.4, int cut = 1, int method = 0, int v2 = 1, int fit2d = 0, int EP = 1, int etamode = 10) {
...
//  Double_t pt_set[8] = {0.6, 1.4, 2.2, 3.0, 3.8, 4.6, 5.4, 7.2};
 ...
 int  rhoorder[3]={0,1,2};
  ...
  string FigureName = Form("./figures/AcceptanceQA/AcceptanceQA_%s%s_method%d_BEFOREandAfter.pdf",vmsa::mBeamEnergy[energy].c_str(),cutoption.c_str(),method);

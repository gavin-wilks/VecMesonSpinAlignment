...
void calculateFPt_EPRes_EffAcc_14GeV(const int energy = 4, const int pid = 0, bool doall = false, bool isBesI = false, bool random3D = false, int etamode = 0, int order = 1) {
...
//  Double_t pt_set[8] = {0.6, 1.4, 2.2, 3.0, 3.8, 4.6, 5.4, 7.2};
  ...
  TFile *fres1 = new TFile("../TreeProduction/StRoot/Utility/EpdResolution/Resolution_file_14GeV_EpdCorrections_6.root","READ");
  ...
  TFile *fres2 = new TFile("../TreeProduction/StRoot/Utility/Resolution/file_14GeV_Resolution.root","READ");
  //TFile *fres2 = new TFile("../TreeProduction/OldUtilityFilesEta1OfficialCent/file_19GeV_Resolution.root","READ");
  //TFile  *fd12 = new TFile("../TreeProduction/StRoot/Utility/EpdResolution/file_19GeV_EpdFlow.root","READ");
  TFile  *fd12 = new TFile("../TreeProduction/StRoot/Utility/EpdResolution/file_14GeV_EpdFlow_6.root","READ");
  ...
  if(order == 1) eff_file_plateau = new TFile(Form("/gpfs01/star/pwg/gwilks3/VectorMesonSpinAlignment/AuAu14GeV_2019/OutPut/CosEfficiencyProccessTuple_EPRes_EffAcc_Ycut_Order1/Eff_%s_SingleParticle_noToF_Mode0_EtaMode%d.root",vmsa::mBeamEnergy[energy].c_str(),etamode),"READ");
  if(order == 2) eff_file_plateau = new TFile(Form("/gpfs01/star/pwg/gwilks3/VectorMesonSpinAlignment/AuAu14GeV_2019/OutPut/CosEfficiencyProccessTuple_EPRes_EffAcc_Ycut_Order2/Eff_%s_SingleParticle_noToF_Mode0_EtaMode%d.root",vmsa::mBeamEnergy[energy].c_str(),etamode),"READ");
